(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const a of e.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function c(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerpolicy&&(e.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?e.credentials="include":r.crossorigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function o(r){if(r.ep)return;r.ep=!0;const e=c(r);fetch(r.href,e)}})();function H(){}function Cn(t){return t()}function mn(){return Object.create(null)}function F(t){t.forEach(Cn)}function hn(t){return typeof t=="function"}function _n(t,n){return t!=t?n==n:t!==n||t&&typeof t=="object"||typeof t=="function"}function Sn(t){return Object.keys(t).length===0}function A(t,n){t.appendChild(n)}function gn(t,n,c){t.insertBefore(n,c||null)}function cn(t){t.parentNode&&t.parentNode.removeChild(t)}function Tn(t,n){for(let c=0;c<t.length;c+=1)t[c]&&t[c].d(n)}function w(t){return document.createElement(t)}function x(t){return document.createTextNode(t)}function U(){return x(" ")}function P(t,n,c,o){return t.addEventListener(n,c,o),()=>t.removeEventListener(n,c,o)}function h(t,n,c){c==null?t.removeAttribute(n):t.getAttribute(n)!==c&&t.setAttribute(n,c)}function Vn(t){return Array.from(t.childNodes)}function E(t,n){n=""+n,t.wholeText!==n&&(t.data=n)}function X(t,n){t.value=n??""}function Mn(t,n,c,o){c===null?t.style.removeProperty(n):t.style.setProperty(n,c,o?"important":"")}function sn(t,n,c){t.classList[c?"add":"remove"](n)}let tn;function J(t){tn=t}const G=[],ln=[],y=[],fn=[],Xn=Promise.resolve();let I=!1;function Fn(){I||(I=!0,Xn.then(Bn))}function K(t){y.push(t)}const O=new Set;let N=0;function Bn(){const t=tn;do{for(;N<G.length;){const n=G[N];N++,J(n),Gn(n.$$)}for(J(null),G.length=0,N=0;ln.length;)ln.pop()();for(let n=0;n<y.length;n+=1){const c=y[n];O.has(c)||(O.add(c),c())}y.length=0}while(G.length);for(;fn.length;)fn.pop()();I=!1,O.clear(),J(t)}function Gn(t){if(t.fragment!==null){t.update(),F(t.before_update);const n=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,n),t.after_update.forEach(K)}}const Pn=new Set;function Jn(t,n){t&&t.i&&(Pn.delete(t),t.i(n))}function Qn(t,n,c,o){const{fragment:r,after_update:e}=t.$$;r&&r.m(n,c),o||K(()=>{const a=t.$$.on_mount.map(Cn).filter(hn);t.$$.on_destroy?t.$$.on_destroy.push(...a):F(a),t.$$.on_mount=[]}),e.forEach(K)}function Hn(t,n){const c=t.$$;c.fragment!==null&&(F(c.on_destroy),c.fragment&&c.fragment.d(n),c.on_destroy=c.fragment=null,c.ctx=[])}function Nn(t,n){t.$$.dirty[0]===-1&&(G.push(t),Fn(),t.$$.dirty.fill(0)),t.$$.dirty[n/31|0]|=1<<n%31}function Wn(t,n,c,o,r,e,a,m=[-1]){const s=tn;J(t);const l=t.$$={fragment:null,ctx:[],props:e,update:H,not_equal:r,bound:mn(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(n.context||(s?s.$$.context:[])),callbacks:mn(),dirty:m,skip_bound:!1,root:n.target||s.$$.root};a&&a(l.root);let f=!1;if(l.ctx=c?c(t,n.props||{},(v,Y,...d)=>{const C=d.length?d[0]:Y;return l.ctx&&r(l.ctx[v],l.ctx[v]=C)&&(!l.skip_bound&&l.bound[v]&&l.bound[v](C),f&&Nn(t,v)),Y}):[],l.update(),f=!0,F(l.before_update),l.fragment=o?o(l.ctx):!1,n.target){if(n.hydrate){const v=Vn(n.target);l.fragment&&l.fragment.l(v),v.forEach(cn)}else l.fragment&&l.fragment.c();n.intro&&Jn(t.$$.fragment),Qn(t,n.target,n.anchor,n.customElement),Bn()}J(s)}class yn{$destroy(){Hn(this,1),this.$destroy=H}$on(n,c){if(!hn(c))return H;const o=this.$$.callbacks[n]||(this.$$.callbacks[n]=[]);return o.push(c),()=>{const r=o.indexOf(c);r!==-1&&o.splice(r,1)}}$set(n){this.$$set&&!Sn(n)&&(this.$$.skip_bound=!0,this.$$set(n),this.$$.skip_bound=!1)}}function xn(t=""){return bn(t).reduce((n,c)=>Math.max(n,c),0)}function kn(t=""){for(var n=bn(t).sort((r,e)=>e-r),c=0,o=0;o<Math.min(3,n.length);o++)c+=n[o];return c}function bn(t){var n=[0];return t.split(`
`).forEach(c=>{c?n[n.length-1]+=parseInt(c):n.push(0)}),n}const On=Object.freeze(Object.defineProperty({__proto__:null,part1:xn,part2:kn},Symbol.toStringTag,{value:"Module"}));function En(t=""){var n={"A X":4,"B X":1,"C X":7,"A Y":8,"B Y":5,"C Y":2,"A Z":3,"B Z":9,"C Z":6};return t.split(`
`).map(c=>n[c]).reduce((c,o)=>c+o)}function In(t=""){var n={"A X":3,"B X":1,"C X":2,"A Y":4,"B Y":5,"C Y":6,"A Z":8,"B Z":9,"C Z":7};return t.split(`
`).map(c=>n[c]).reduce((c,o)=>c+o)}const Kn=Object.freeze(Object.defineProperty({__proto__:null,part1:En,part2:In},Symbol.toStringTag,{value:"Module"}));function n1(t=""){var n=0;return t.split(`
`).forEach(c=>{c=c.trim();for(var o={},r=c.length/2,e=0;e<r;e++)o[c.charAt(e)]=!0;for(var a=r;a<c.length;a++)if(o[c.charAt(a)]){n+=jn(c,a);return}}),n}function c1(t=""){var n,c,o=0;return t.split(`
`).forEach((r,e)=>{r=r.trim();var a=e%3;if(a===0){n={};for(var m of r)n[m]=!0}else if(a===1){c={};for(var m of r)n[m]&&(c[m]=!0)}else for(var m of r)if(c[m]){o+=jn(m,0);return}}),o}function jn(t,n){var c=t.charCodeAt(n);return c>95?c-96:c-38}const t1=Object.freeze(Object.defineProperty({__proto__:null,part1:n1,part2:c1},Symbol.toStringTag,{value:"Module"}));function r1(t=""){var n=0;return t.split(`
`).forEach(c=>{var[o,r]=c.split(","),[e,a]=o.split("-").map(l=>parseInt(l)),[m,s]=r.split("-").map(l=>parseInt(l));e<m&&s>a||m<e&&a>s||n++}),n}function o1(t=""){var n=0;return t.split(`
`).forEach(c=>{var[o,r]=c.split(","),[e,a]=o.split("-").map(l=>parseInt(l)),[m,s]=r.split("-").map(l=>parseInt(l));a<m||e>s||n++}),n}const a1=Object.freeze(Object.defineProperty({__proto__:null,part1:r1,part2:o1},Symbol.toStringTag,{value:"Module"}));function e1(t=""){var n=[];return t.split(`
`).forEach(c=>{if(c.includes("["))for(var o=1;o<c.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var e=c.charAt(o);e!==" "&&n[r].unshift(e)}if(c.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(c);if(!a)return;for(var m=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,o=0;o<m;o++){var f=n[s].pop();n[l].push(f)}}}),n.map(c=>c[c.length-1]).join("")}function m1(t=""){var n=[];return t.split(`
`).forEach(c=>{if(c.includes("["))for(var o=1;o<c.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var e=c.charAt(o);e!==" "&&n[r].unshift(e)}if(c.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(c);if(!a)return;var m=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,f=n[s],v=f.splice(f.length-m);n[l]=n[l].concat(v)}}),n.map(c=>c[c.length-1]).join("")}const s1=Object.freeze(Object.defineProperty({__proto__:null,part1:e1,part2:m1},Symbol.toStringTag,{value:"Module"}));function l1(t=""){return wn(t,4)}function f1(t=""){return wn(t,14)}function wn(t,n){for(var c=0,o=0;o<t.length;o++){if(c++,c===n)return o+1;for(var r=1;r<n-c+1;r++)if(t[o]===t[o+r]){c=0;break}}return-1}const v1=Object.freeze(Object.defineProperty({__proto__:null,part1:l1,part2:f1},Symbol.toStringTag,{value:"Module"}));function Y1(t=""){var n=Ln(t),c=rn(n),o=0;return c.forEach(r=>{r.size<1e5&&(o+=r.size)}),o}function d1(t=""){var n=Ln(t),c=rn(n),o=7e7-n.size,r=3e7-o,e=1/0;return c.forEach(a=>{a.size>r&&a.size<e&&(e=a.size)}),e}function nn(t){this.parent=t,this.children={},this.size=0}function p1(t="a",n="1"){this.name=t,this.size=parseInt(n)}function Ln(t){var n=new nn(null),c=n;return t.split(`
`).forEach(o=>{if(o=o.trim(),/^\$ cd /.test(o)){var r=o.substring(5);r==="/"?c=n:r===".."?c=c.parent:c=c.children[r]}else if(!/^\$ ls/.test(o))if(/^dir /.test(o)){var e=o.substring(4);c.children[e]=c.children[e]||new nn(c)}else if(/^\d+ \S+$/.test(o)){var[a,m]=o.split(" ");c.children[m]=c.children[m]||new p1(m,a)}else console.log("err",o);if(!c)return console.log("err",c,n),""}),n}function rn(t,n=[]){n.push(t);var c=0;for(var o in t.children){var r=t.children[o];r instanceof nn&&rn(r,n),c+=r.size}return t.size=c,n}const A1=Object.freeze(Object.defineProperty({__proto__:null,part1:Y1,part2:d1},Symbol.toStringTag,{value:"Module"}));function C1(t=""){var n=[];t.split(`
`).forEach((a,m)=>{n[m]=[],a.split("").forEach(s=>{var l=parseInt(s);n[m].push({ht:l,viz:!1})})});var c=(a,m=1)=>{for(var s=-1,l=0;l<a.length;l++){var f=m>0?a[l]:a[a.length-l-1];f.ht>s&&(f.viz=!0,s=f.ht)}};n.forEach(a=>c(a)),n.forEach(a=>c(a,-1));for(var o=0;o<n[0].length;o++){var r=n.map(a=>a[o]);c(r),c(r,-1)}var e=0;return n.forEach(a=>{a.forEach(m=>{m.viz&&e++})}),e}function h1(t=""){var n=[];t.split(`
`).forEach((a,m)=>{n[m]=[],a.split("").forEach(s=>{var l=parseInt(s);n[m].push({ht:l,score:1})})});var c=0,o=a=>{for(var m=0;m<a.length;m++){for(var s=a[m],l=0,f=m-1;f>=0;f--){var v=a[f];if(l++,v.ht>=s.ht)break}for(var Y=0,d=m+1;d<a.length;d++){var C=a[d];if(Y++,C.ht>=s.ht)break}s.score*=l,s.score*=Y,s.score>c&&(c=s.score)}};n.forEach(a=>o(a));for(var r=0;r<n[0].length;r++){var e=n.map(a=>a[r]);o(e)}return c}const i1=Object.freeze(Object.defineProperty({__proto__:null,part1:C1,part2:h1},Symbol.toStringTag,{value:"Module"}));function g1(t=""){var n=[0,0],c=[0,0],o={},r=a=>o[a.join(",")]=!0,e={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return r(c),t.split(`
`).forEach((a,m)=>{for(var[s,l]=a.trim().split(/\s+/),f=e[s],v=parseInt(l),Y=0;Y<v;Y++)n[0]+=f[0],n[1]+=f[1],Dn(n,c),r(c)}),Object.keys(o).length}function Dn(t,n){var c=t[0]-n[0],o=t[1]-n[1],r=t[0]>n[0]?1:-1,e=t[1]>n[1]?1:-1;c===0||o===0?(Math.abs(c)>1&&(n[0]+=r),Math.abs(o)>1&&(n[1]+=e)):(Math.abs(c)>1||Math.abs(o)>1)&&(n[0]+=r,n[1]+=e)}function B1(t=""){var n=Array.from(Array(10)).map(e=>[0,0]),c={},o=e=>c[e.join(",")]=!0,r={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return o(n[0]),t.split(`
`).forEach((e,a)=>{for(var[m,s]=e.trim().split(/\s+/),l=r[m],f=parseInt(s),v=0;v<f;v++){n[0][0]+=l[0],n[0][1]+=l[1];for(var a=1;a<n.length;a++)Dn(n[a-1],n[a]);o(n[n.length-1])}}),Object.keys(c).length}const b1=Object.freeze(Object.defineProperty({__proto__:null,part1:g1,part2:B1},Symbol.toStringTag,{value:"Module"}));function j1(t=""){var n=0,c={20:!0,60:!0,100:!0,140:!0,180:!0,220:!0},o=(a,m)=>{a in c&&(n+=m*a)},r=1,e=1;return t.split(`
`).forEach(a=>{for(var[m,s]=a.trim().split(/\s+/),l=m==="addx"?2:1;l-- >0;)o(r,e),r++;m==="addx"&&(e+=parseInt(s))}),n}function w1(t=""){var n="",c=(e,a)=>{var m=(e-1)%40;m===0&&e>1&&(n+=`
`);var s=Math.abs(m-a);n+=s<2?"#":"."},o=1,r=1;return t.split(`
`).forEach(e=>{for(var[a,m]=e.trim().split(/\s+/),s=a==="addx"?2:1;s-- >0;)c(o,r),o++;a==="addx"&&(r+=parseInt(m))}),n}const L1=Object.freeze(Object.defineProperty({__proto__:null,part1:j1,part2:w1},Symbol.toStringTag,{value:"Module"}));function D1(){this.items=[],this.op=()=>{},this.div=1,this.next=[0,0],this.count=0}function Rn(t){var n=[],c=null;return t.split(`
`).forEach(o=>{var r=o.trim().split(/\s+/);if(r[0]==="Monkey")c=new D1,n.push(c);else if(r[0]==="Starting")c.items=r.slice(2).map(m=>parseInt(m));else if(r[0]==="Operation:"){var e=r.pop(),a=r.pop();c.op=(()=>{if(e==="old"){if(a==="+")return s=>s+s;if(a==="*")return s=>s*s;throw"unhandled"}var m=parseInt(e);if(!isNaN(m)){if(a==="+")return s=>s+m;if(a==="*")return s=>s*m}throw"unhandled"})()}else r[0]==="Test:"?c.div=parseInt(r.pop()):r[1]==="true:"?c.next[0]=parseInt(r.pop()):r[1]==="false:"&&(c.next[1]=parseInt(r.pop()))}),n}function R1(t=""){for(var n=Rn(t),c=0;c<20;c++)n.forEach(o=>{o.items.forEach(r=>{o.count++,r=o.op(r),r=Math.floor(r/3);var e=r%o.div===0?0:1,a=o.next[e];n[a].items.push(r)}),o.items=[]});return n.sort((o,r)=>r.count-o.count),n[0].count*n[1].count}function q1(t=""){for(var n=Rn(t),c=n.reduce((r,e)=>r*e.div,1),o=0;o<1e4;o++)n.forEach(r=>{r.items.forEach(e=>{r.count++,e=r.op(e),e=e%c;var a=e%r.div===0?0:1,m=r.next[a];n[m].items.push(e)}),r.items=[]});return n.sort((r,e)=>e.count-r.count),n[0].count*n[1].count}const u1=Object.freeze(Object.defineProperty({__proto__:null,part1:R1,part2:q1},Symbol.toStringTag,{value:"Module"}));function qn(t){var n=[-1,-1],c=[-1,-1],o=[];t.split(`
`).forEach((e,a)=>{var m=e.trim().split("").map((s,l)=>{var f=s.charCodeAt(0)-96,v=9999;return s==="S"&&(n=[l,a],f=1),s==="E"&&(c=[l,a],f=26),{ht:f,steps:v}});o.push(m)});var r=(e,a)=>e<0||e>=o[0].length||a<0||a>=o.length?null:o[a][e];return{start:n,end:c,getData:r}}function z1(t=""){var{start:n,end:c,getData:o}=qn(t);o(...n).steps=0;for(var r=[n],e=(l,f,v,Y)=>{var d=o(l,f);if(d){if(d.ht>v+1||d.steps<=Y)return;d.steps=Y,r.push([l,f])}};r.length>0;){var[a,m]=r.pop(),s=o(a,m);e(a-1,m,s.ht,s.steps+1),e(a+1,m,s.ht,s.steps+1),e(a,m-1,s.ht,s.steps+1),e(a,m+1,s.ht,s.steps+1)}return o(c[0],c[1]).steps}function Z1(t=""){var{end:n,getData:c}=qn(t);c(...n).steps=0;for(var o=[n],r=9999,e=(l,f,v,Y)=>{var d=c(l,f);if(d){if(d.ht<v-1||d.steps<=Y)return;d.steps=Y,o.push([l,f]),d.ht===1&&(r=Math.min(r,d.steps))}};o.length>0;){var[a,m]=o.pop(),s=c(a,m);e(a-1,m,s.ht,s.steps+1),e(a+1,m,s.ht,s.steps+1),e(a,m-1,s.ht,s.steps+1),e(a,m+1,s.ht,s.steps+1)}return r}const $1=Object.freeze(Object.defineProperty({__proto__:null,part1:z1,part2:Z1},Symbol.toStringTag,{value:"Module"}));function U1(t=""){var n=t.split(`
`).map(o=>o.trim()).filter(o=>o).map(un),c=0;return n.forEach((o,r)=>{if(r%2!==0){var e=Q(n[r-1],o);e<0&&(c+=(r+1)/2)}}),c}function _1(t=""){t+=`
  [[2]]  
  [[6]] `;var n=t.split(`
`).map(o=>o.trim()).filter(o=>o).map(un).sort(Q),c=1;return n.forEach((o,r)=>{if(o.length===1&&o[0].length===1){var e=o[0][0];(e===2||e===6)&&(c*=r+1)}}),c}function Q(t,n){if(typeof t=="number")return typeof n=="number"?t-n:Q([t],n);if(typeof n=="number")return Q(t,[n]);for(var c=Math.min(t.length,n.length),o=0;o<c;o++){var r=Q(t[o],n[o]);if(r!==0)return r}return t.length-n.length}function un(t){if(t[0]!=="[")throw["err-1",t].join(" ");for(var n=[],c=[n],o=1;o<t.length-1;o++){var r=t[o];if(r!==","){if(r==="]"){c.pop();continue}var e=c[c.length-1];if(r==="["){var a=[];e.push(a),c.push(a);continue}var m=/^\d+/.exec(t.substring(o));if(!m)throw["err-2",o,t].join(" ");e.push(parseInt(m[0])),o+=m.length-1}}return n}const S1=Object.freeze(Object.defineProperty({__proto__:null,part1:U1,part2:_1},Symbol.toStringTag,{value:"Module"}));function T1(t=""){for(var n=new zn(t),c=0;c<99999;c++)if(n.sandComesToRestAt(500,0)>n.maxY)return c;throw"err"}function V1(t=""){for(var n=new zn(t),c=0;c<99999;c++)if(n.sandComesToRestAt(500,0)<0)return c;throw"err"}function zn(t){var n=[],c=-99999,a=99999,o=(m,s)=>{n[m]||(n[m]=[]),n[m][s]=!0,c=Math.max(c,s)},r=(m,s)=>s>=a?!0:n[m]&&n[m][s]||!1,e=(m,s,l,f)=>{for(var v=m===l?0:m<l?1:-1,Y=s===f?0:s<f?1:-1,d=Math.max(Math.abs(m-l),Math.abs(s-f)),C=0;C<=d;C++)o(m,s),m+=v,s+=Y};t.split(`
`).forEach(m=>{var s;m.split("->").forEach((l,f)=>{var v=l.split(",").map(Y=>parseInt(Y));s&&e(...s,...v),s=v})}),this.maxY=c;var a=c+2;this.sandComesToRestAt=(m,s)=>{if(r(m,s))return s-1;for(var l=0;l<99999;l++){if(!r(m,s+1)){s++;continue}if(!r(m-1,s+1)){m--,s++;continue}if(!r(m+1,s+1)){m++,s++;continue}return o(m,s),s}}}const M1=Object.freeze(Object.defineProperty({__proto__:null,part1:T1,part2:V1},Symbol.toStringTag,{value:"Module"}));function X1(t=""){var n=Zn(t),c=2e6,o=1/0,r=-1/0;return n.forEach(({sx:e,sy:a,dist:m})=>{var s=m-Math.abs(a-c);s<0||(o=Math.min(o,e-s),r=Math.max(r,e+s))}),r-o}function F1(t=""){for(var n=Zn(t),c=4e6,o=0;o<=c;o++)for(var r=0;r<=c;r++){var e=n.some(({sx:a,sy:m,dist:s})=>{var l=s-Math.abs(m-o);if(!(l<0)){var f=Math.abs(a-r);if(!(f>l))return r=a+l,!0}});if(!!e&&!(r>c))return 4e6*r+o}return"no hits"}function Zn(t){return t.trim().split(`
`).map(n=>{var c=/Sensor at x=(.+), y=(.+): closest beacon is at x=(.+), y=(.+)/.exec(n.trim());if(!c)throw"?";var[,o,r,e,a]=c.map(s=>parseInt(s)),m=Math.abs(e-o)+Math.abs(a-r);return{sx:o,sy:r,dist:m}})}const G1=Object.freeze(Object.defineProperty({__proto__:null,part1:X1,part2:F1},Symbol.toStringTag,{value:"Module"}));function P1(t=""){var{rates:n,distances:c}=$n(t),o=Object.keys(n).filter(v=>n[v]>0),r=[],e=(v,Y,d,C)=>{r.push({t:v,tot:Y,loc:d,done:C})},a=0;for(e(0,0,"AA","");r.length>0;){var{t:m,tot:s,loc:l,done:f}=r.pop();o.forEach(v=>{if(!f.includes(v)){var Y=m+c[l][v]+1;if(!(Y>=30)){var d=n[v]*(30-Y),C=s+d;C>a&&(a=C),e(Y,C,v,f+","+v)}}})}return a}function J1(t=""){var{rates:n,distances:c}=$n(t),o=Object.keys(n).filter(b=>n[b]>0),r=[],e=(b,$,p,L,q,B)=>{r.push({t1:b,t2:$,tot:p,loc1:L,loc2:q,done:B}),r.length>5e3&&(r.sort((R,T)=>T.tot-R.tot),r.length=4e3)},a=0;e(4,4,0,"AA","AA","");for(var m=0;m<30;m++){var s=r;for(r=[];s.length>0;){var{t1:l,t2:f,tot:v,loc1:Y,loc2:d,done:C}=s.pop(),[g,z]=l<f?[l,f]:[f,l],[V,Z]=l<f?[Y,d]:[d,Y];o.forEach(b=>{if(!C.includes(b)){var $=g+c[V][b]+1;if(!($>=30)){var p=n[b]*(30-$),L=v+p,q=C+","+b;L>a&&(a=L),e(z,$,L,Z,b,q)}}})}}return a}function $n(t){var n={},c={},o={};t.trim().split(`
`).forEach(e=>{var a=/Valve (.+) has flow rate=(.+); tunnels? leads? to valves? (.+)/.exec(e.trim());if(!a)throw`?? ${e}`;var[,m,s,l]=a;n[m]=parseInt(s),c[m]=l.split(",").map(f=>f.trim()),o[m]={}});var r=(e,a,m)=>{var s=o[e][a]||999;s<=m||(o[e][a]=m,c[a].forEach(l=>r(e,l,m+1)))};return Object.keys(n).forEach(e=>r(e,e,0)),{rates:n,distances:o}}const Q1=Object.freeze(Object.defineProperty({__proto__:null,part1:P1,part2:J1},Symbol.toStringTag,{value:"Module"}));var vn=[["1111"],["010","111","010"],["111","100","100"],["1","1","1","1"],["11","11"]].map(t=>t.map(n=>parseInt(n,2)<<2));function H1(t){for(var n=0;n<t.length;n++){var c=t.length-1-n,o=t[c].toString(2).padStart(7,"#");o=o.split("").map(r=>r==="1"?"#":".").reverse().join(""),console.log("|"+o+"|     "+c)}console.log("                     ")}function Un(t){var n=t.trim().split("").map(l=>l==="<"?-1:1),c=[],o=0,r=0,e=l=>l>>1,a=l=>l<<1,m=(l,f,v)=>f.every((Y,d)=>(Y&l[v+d])===0),s=2**6;this.rows=c,this.debug=()=>H1(c),this.dropRock=()=>{for(var l=vn[r++%vn.length].slice();c[c.length-1]===0;)c.pop();for(var f=c.length+3;c.length<f+l.length;)c.push(0);for(var v=!0;v;){var Y=n[o++%n.length],d=l.every(g=>Y<1?(g&1)===0:(g&s)===0);if(d){var C=l.map(Y<0?e:a);m(c,C,f)&&(l=C)}v=f>0&&m(c,l,f-1),v&&f--}for(l.forEach((g,z)=>{c[f+z]|=g});c[c.length-1]===0;)c.pop()}}function N1(t=""){for(var n=new Un(t),c=0;c<2022;c++)n.dropRock();return n.rows.length}function W1(t=""){var n=new Un(t),c=[0],o=[""],r=0,e=0;n:for(var a=1;a<3e3;a++){n.dropRock();var f=n.rows.length,m=n.rows.slice(-30).join(",");c[a]=f,o[a]=m;for(var s=50;s<a/2;s++)if(o[s]===m){r=s,e=a-s;break n}}if(r===0)throw"?";var l=1e12;l-=r;var f=c[r],v=Math.floor(l/e),Y=c[r+e]-c[r];return f+=Y*v,l%=e,f+=c[r+l]-c[r],f}const y1=Object.freeze(Object.defineProperty({__proto__:null,part1:N1,part2:W1},Symbol.toStringTag,{value:"Module"})),x1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),k1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),O1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),E1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),I1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),K1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),n5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),c5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),t5=`5557
6663
3952
4750
2271
...
cjlhShjchhjGGmNVjplcQgmTPtHPPJmQgQHgtqgZ`,a5=`8-82,3-96
13-95,99-99
4-92,5-93
16-80,16-80
23-36,6-10
...
move 2 from 4 to 6
move 1 from 4 to 7
move 6 from 1 to 8`,m5="",s5=`$ cd /
$ ls
dir bqc
dir mwmlf
dir ngn
...
$ cd zdqprndl
$ ls
197398 tprth.gjn`,l5=`200111110420341122211300354132530435302054046335421000636521353401523010501311544011230232023001001
...
202312021141114142554431112520342120400556304244541024562551661211241403030453530144444200321002011`,f5=`U 1
D 2
U 1
L 1
R 1
...
Monkey 7:
  ...
  Test: divisible by 7
    ...
    If false: throw to monkey 0`,d5=`abcccccccccaaaaaaaaaaccccccccccccaaaaaaaaccaaccccccccccccccccccccccccccccccccccccccccccccaaaaaa
...
abccccccccccccccccccccaaaaacccaaaaaaaaaaaacccccccccaacaacccccccccccccccccccccccccccccccccaaaaaa`,p5=`[[[[8,6]],[8,[7],[6,7,6,2,4]],10,[[1,7,9],7,[7,9]]],[[4,[],[10,5],[5,4,7],5],8,9,[[5,3,3,6,9],[9,5,10],8],[[0,6,9],[8],4,6,8]]]
...
[[7,[]]]
[[[],9,[[0,9,1],[6],9,[8,4,10,4,7],[6]]],[3,[2,[0,5],7,9],2],[[[9],7,[1,7],9]]]`,A5=`495,144 -> 499,144
...
507,181 -> 507,171 -> 507,181 -> 509,181 -> 509,173 -> 509,181 -> 511,181 -> 511,176 -> 511,181 -> 513,181 -> 513,176 -> 513,181
499,13 -> 499,17 -> 497,17 -> 497,25 -> 505,25 -> 505,17 -> 502,17 -> 502,13
500,158 -> 500,159 -> 513,159`,C5=`Sensor at x=3907621, y=2895218: closest beacon is at x=3790542, y=2949630
...
Sensor at x=2194423, y=3990859: closest beacon is at x=2275951, y=3717327`,h5=`Valve EJ has flow rate=25; tunnel leads to valve MC
...
Valve UI has flow rate=0; tunnels lead to valves AR, CB`,i5=">>>><<<><<<>><<>>>><>>><<<>><<<>><<<<>>>><>>><<>><<<>>>><<<<>>><<><>>><<<<>>>><>><<><<<><<<><<>><><><<<<>>><<<<><<>>>><<>>>><>><<<<>><<<>><<<<>>><<<>>>><<>>><>><>>><>><<>>>><<><><<<>>><<><><<<<>><<<>>><<<<>>>><<><<>>><<<>>><<<><<<<>>>><<<>><><<<>>><<<>>><<<<><<<>>>><<>>><>>><<<<>>>><>><<<<>><<<>>>><<>><>>>><<<>>><<>><<<>>>><>>>><><<>>>><<<>><<>><<>>>><<<>>><<>>><<<<>>><<<<>>>><<<<>>>><>><<<>>><<>><>>><>>><<>>><>>><<<>>><<<<>><<><<<><>>>><<<><>>>><<<<>>><<<<>><><<<<>>><<><<<<>>><<<<>><>><>>><<<><<<<>>>><><><<<>><<<<>><<<>><<<><<<<>>>><<<<>>><<<>>><>><<<<><<<>><<<>><>><<<<><><>>><<>>>><>>><>>><<<<>><<>><<>><<<>><<><<<<>><><<<<>><<>>>><<>>>><>>><<<>><<<<>><<<>>>><<<<>><<<<>>><<>>>><>>><<<<>>><<<<><<><<<><<<<>><<<>><<<><<<>>><<<<>><<<>>><><<>>><>>>><<<<>>>><<<>>><<>><><>>><<<><<>><>><<>>>><<<<><<>><<<<><<>>><<<<>><<<>>><<<>>>><>><<><<<><>><<<>>>><<<<>>><><<<<><<><<<>><<<<>><<<>><>>><<><<><<>>>><<>>>><<>>>><><<>>>><<<<>>><<<>>><<<>>><<<<>>><<<>><<<<><><><<<>><<<<>>>><<<<>>>><<<
>><><>><<<>>>><<>><>><<>>>><<<<>>>><<<<>>>><<<><<>><<<<>>><<<<>>><<<<>>><<<<>><<<<>>><<<>><<>>><<<<>>><<>>>><<<>><>><>>><>>>><>><<<<><><<>>>><>>><<<>>>><<<>>>><<>>><<<<>><>>><<<<>>>><><<<<><<>><>>>><>>><<>>>><><<><<<<>><<<><><<<<>><<>>>><<<<>><>><<>><<>><<><<<>>><><>>><<<>>>><<<<><>>>><><>>>><<<<>>><<>><<>><<<<>>>><<>>>><<<<>>>><><<<><<>>><<<<>>>><<>>>><>>>><<<<>><<<>><<>>><<<<>>>><<<<>>>><<<<>><<<<><>>>><>>><<<<><<<<>>>><<<><<<<><<>>><>>>><<<>>><<<<>>><<>>>><<>>><<<<><<<<>>>><>>>><<<>><<<<>><>>>><>>><<<<>>>><>>>><<>>><<<>>>><>><<<<>>><<>>><<><<<><<<<>><<<<>><<><<<<><<<>>><<>>>><<<><<<<>>><<>><<<<>>>><>><<>>><<<<>>>><<<>>>><><>>><>>><<<<><>><<>>>><>>>><<>>>><<<<><>>>><<<>>>><<<<>>>><>><<<<><<<<>><<<>><<>>><<><<>>><<>><>>>><><<<>>>><<<<><<<>><<<<><<><>>><<>>>><<><<<<>><><<<>>><<<<>>><<<<><<<<>><>>>><<><<<>>><<>><<<<>>>><>>>><>>>><>><<<<><<<>>>><<<>><<<>>>><>>>><<<<>>>><<<>>>><<><<><<>><<><<<>>><<<<>><>>><<><<<<>><<<<>>>><<<<>>><<>>>><>><<<<>><><<<<>><<>><<<<>>>><<>>>><<<<>><>>><<<>><<><>>><<>><<<><<<<>>><>>>><<>><<>>><<>><<><<>>><<<<><<>>>><<>>>><<>><>>>><<>><>><>><<<<>>>><>>>><<<>>>><<<<>>>><<><<>>><><<>>><>>><><<<>><<<<>>><<<><<<<>>>><<<>>>><><>>><<<><<<>>><<<<><<<<>>><<>><<>><><<>>><<<><<<<>><>><<><<<>>><<>>><<>>>><>><>>><<<>><>>>><<<<><<<<>>>><><>>><>><><<<>>>><<<<>><<>><><>>><<<><<><<>>>><<<>>><>>>><<<<>>>><>><<<<><>>>><>>>><<<>>><<><<>>>><<>>><<<>>><<<>>><><<<>><<<<>>>><<>>>><<<<>>><<<>>><<<<><<>><>>>><>>>><<><<<<>><<<<>>><<<<>>><>>><><<>><<<><<<><<<>><<>>>><>><>>><><<<><<><>>>><<<<><<<>>>><><<><>>><<<<>>><<<>><<<<>>><<>>>><>>><>><<>><<<<>><<><<>><>>>><<>>><<<>><><<>>>><<>>><<>><<>><<<>>><<<>>>><<<<><<<<>>><<<>><>>><<<>><<<>>><<<>>>><<<<>><<<<>>><<><<<<>>><><<>>>><<<><<<<>>><<<<>>><<<>>>><<><<<<>>>><>>><<><<<<>>><>>>><<<<>>><><<<>>><>>><<>>>><<<>>><<<<>><<<<>><<>>><<<<>><>>>><<<<>>>><<<<>>><>><<>>>><<<<>>>><<<<>><<<>>><<<>>><>>><>>>><>><><>><<><<><
<>>><<>>><<<<>>><<>>><<<<><<<<>><<<<>>><<<>><><<<><>><<<<><<<<>><<<<><<<>>>><<><<><>>><<<<>><<<<>>>><>>><>><<>><<>><<<<>><>>>><<<<>>>><<<>>>><<>><><<<<>>><<<<>>>><<<>>><<><>>><<<<>>>><<<<>>>><<><>>>><<<<><<<><<<<>>><<<<><<<>>>><<<<>><<<>>><<<>>>><<><<><>>>><>>>><<<<>><>><<>>><<<><><<>>><<<>><<>>><<<><<<>>><<>>><<>>>><<<><>>>><><<<>>><>><<<>><<><<<>>><>>><<<<>>>><<<>>><>>><<>><<<>>><>><<>><>>>><<<<><<<>>>><><<<<><<<<><<<<><<>>>><<>>>><<>><<<<>><<<>>><<><<<>>>><<<<>>>><<<>>>><<<><<<>>>><<>>>><<<<>><>><<>>>><>>>><<<>><<<>><>>>><<<>>><>><>>>><>><<<<>><<>>><>><<>>><<<<>><><<<>><<<<>>><>>>><<<<>>><<<><<<>><<><<>>>><>>><<<><<>><<<><<>>>><><<<<>><<<>>><<>>><>>>><>>><>>>><<<><>><<<>>>><>>><<<>>><<><<>><<<<><<><>><<<>>><<<>>><<<>>>><<<><<<<>>><<<<><<<><<<>>>><<>>><>>>><<<>><<>>>><<><<<<><<<<>><<>>><<><<>><<><>>>><>><<<<>>><<<<>>>><<<><<<<>>>><>>>><<<><<>><<>>><<<<>><<>><<>>>><>>><>>><<>><>>><<>><<<<>>><><<>>><<<<>><<<>>><<<>><><<<<>><<<<>>><<<>><<<>>><>>>><<<>>>><<>>><>><>><<<<>>>><<<>>>><<>><<<<>>><<<<>>><><>><<><>>>><<<<>><<>>><>>>><<<><<<<>>>><>>><<<<>>>><<><<<<>>><<<<>>><<<<>>>><><<>><<>><<<>><<><<<>>>><<<>>>><<>><<<<>><>><<<>>>><<<<><<<>>>><<<>>><<<<>>>><<>>>><<<><<<<>>>><><>><<>>><<<<><><<>>>><<<>>>><<<><<<<>><<<<>>><<<><<<>><<><<<>>>><<>>><>><>><<>>>><><<><<<<>>><<>>>><<<<>>><<<<><><<<><<<>>><<><<>>>><<<>>><<<>><<>>>><<<<>>>><>><<>>><<>>>><<<><<>>>><<<>>>><<<<>>>><<<<><<<<><<<><<<<>>>><<>>><<>>><<>><<><<>>><<<>>>><>><<<><<>>>><<>><<><<<>>>><>><>>>><<>>>><><>><<<<><<<<>>><<<><<>><<>>><<<<>>>><>>>><<><<<>>><<<>>>><<>>><<>><<>",g5="",B5="",b5="",j5="",w5="",L5="",D5="",R5="";var Yn=Object.assign({"./solutions/solution-01.js":On,"./solutions/solution-02.js":Kn,"./solutions/solution-03.js":t1,"./solutions/solution-04.js":a1,"./solutions/solution-05.js":s1,"./solutions/solution-06.js":v1,"./solutions/solution-07.js":A1,"./solutions/solution-08.js":i1,"./solutions/solution-09.js":b1,"./solutions/solution-10.js":L1,"./solutions/solution-11.js":u1,"./solutions/solution-12.js":$1,"./solutions/solution-13.js":S1,"./solutions/solution-14.js":M1,"./solutions/solution-15.js":G1,"./solutions/solution-16.js":Q1,"./solutions/solution-17.js":y1,"./solutions/solution-18.js":x1,"./solutions/solution-19.js":k1,"./solutions/solution-20.js":O1,"./solutions/solution-21.js":E1,"./solutions/solution-22.js":I1,"./solutions/solution-23.js":K1,"./solutions/solution-24.js":n5,"./solutions/solution-25.js":c5}),dn=Object.assign({"./inputs/input-01.txt":t5,"./inputs/input-02.txt":r5,"./inputs/input-03.txt":o5,"./inputs/input-04.txt":a5,"./inputs/input-05.txt":e5,"./inputs/input-06.txt":m5,"./inputs/input-07.txt":s5,"./inputs/input-08.txt":l5,"./inputs/input-09.txt":f5,"./inputs/input-10.txt":v5,"./inputs/input-11.txt":Y5,"./inputs/input-12.txt":d5,"./inputs/input-13.txt":p5,"./inputs/input-14.txt":A5,"./inputs/input-15.txt":C5,"./inputs/input-16.txt":h5,"./inputs/input-17.txt":i5,"./inputs/input-18.txt":g5,"./inputs/input-19.txt":B5,"./inputs/input-20.txt":b5,"./inputs/input-21.txt":j5,"./inputs/input-22.txt":w5,"./inputs/input-23.txt":L5,"./inputs/input-24.txt":D5,"./inputs/input-25.txt":R5});function q5(t,n,c){this.day=t||"0",this.input=n||"",this.part1=c.part1||null,this.part2=c.part2||null}function u5(){var t={},n={};Object.keys(dn).forEach(r=>{var e=/input-(..)/.exec(r)[1];t[e]=dn[r]||""}),Object.keys(Yn).forEach(r=>{var e=/solution-(..)/.exec(r)[1];n[e]=Yn[r]||null});var c={},o=Object.keys(t).sort();return o.forEach(r=>{c[r]=new q5(r,t[r],n[r])}),c}function pn(t,n,c){const o=t.slice();return o[18]=n[c],o}function An(t){let n,c=t[18]+"",o,r,e;function a(){return t[8](t[18])}return{c(){n=w("span"),o=x(c),h(n,"class","button svelte-1cclp05"),sn(n,"current",t[18]===t[2])},m(m,s){gn(m,n,s),A(n,o),r||(e=[P(n,"keydown",Z5),P(n,"click",a)],r=!0)},p(m,s){t=m,s&2&&c!==(c=t[18]+"")&&E(o,c),s&6&&sn(n,"current",t[18]===t[2])},d(m){m&&cn(n),r=!1,F(e)}}}function z5(t){let n,c,o,r,e,a,m,s,l,f,v,Y,d,C,g,z,V,Z,b,$,p,L,q,B,R,T,S,on,_,k,an,M=t[1],D=[];for(let i=0;i<M.length;i+=1)D[i]=An(pn(t,M,i));return{c(){n=w("div"),c=w("h2"),c.textContent="Advent 2022",o=U(),r=w("div"),e=w("div"),e.innerHTML='<h4 class="svelte-1cclp05">Days:</h4>',a=U(),m=w("div");for(let i=0;i<D.length;i+=1)D[i].c();s=U(),l=w("div"),f=w("h4"),f.textContent="Output 1:",v=U(),Y=w("div"),d=x(t[5]),C=U(),g=w("textarea"),V=U(),Z=w("div"),b=w("h4"),b.textContent="Output 2:",$=U(),p=w("div"),L=x(t[6]),q=U(),B=w("textarea"),T=U(),S=w("div"),S.innerHTML='<h4 class="svelte-1cclp05">Input:</h4>',on=U(),_=w("textarea"),h(e,"class","label svelte-1cclp05"),h(m,"class","day-list"),h(f,"class","svelte-1cclp05"),h(Y,"class","time svelte-1cclp05"),h(l,"class","label svelte-1cclp05"),h(g,"name","output1"),h(g,"id","output1"),h(g,"rows",z=W(t[3])),h(g,"class","svelte-1cclp05"),h(b,"class","svelte-1cclp05"),h(p,"class","time svelte-1cclp05"),h(Z,"class","label svelte-1cclp05"),h(B,"name","output2"),h(B,"id","output2"),h(B,"rows",R=W(t[4])),h(B,"class","svelte-1cclp05"),h(S,"class","label svelte-1cclp05"),Mn(S,"align-self","flex-start"),h(_,"name","input"),h(_,"id","input"),h(_,"rows","14"),h(_,"class","svelte-1cclp05"),h(r,"class","layout svelte-1cclp05"),h(n,"class","outer svelte-1cclp05")},m(i,u){gn(i,n,u),A(n,c),A(n,o),A(n,r),A(r,e),A(r,a),A(r,m);for(let j=0;j<D.length;j+=1)D[j].m(m,null);A(r,s),A(r,l),A(l,f),A(l,v),A(l,Y),A(Y,d),A(r,C),A(r,g),X(g,t[3]),A(r,V),A(r,Z),A(Z,b),A(Z,$),A(Z,p),A(p,L),A(r,q),A(r,B),X(B,t[4]),A(r,T),A(r,S),A(r,on),A(r,_),X(_,t[0]),k||(an=[P(g,"input",t[9]),P(B,"input",t[10]),P(_,"input",t[11])],k=!0)},p(i,[u]){if(u&134){M=i[1];let j;for(j=0;j<M.length;j+=1){const en=pn(i,M,j);D[j]?D[j].p(en,u):(D[j]=An(en),D[j].c(),D[j].m(m,null))}for(;j<D.length;j+=1)D[j].d(1);D.length=M.length}u&32&&E(d,i[5]),u&8&&z!==(z=W(i[3]))&&h(g,"rows",z),u&8&&X(g,i[3]),u&64&&E(L,i[6]),u&16&&R!==(R=W(i[4]))&&h(B,"rows",R),u&16&&X(B,i[4]),u&1&&X(_,i[0])},i:H,o:H,d(i){i&&cn(n),Tn(D,i),k=!1,F(an)}}}function W(t){var n=String(t||"").split(`
`).length;return Math.min(n,Math.max(n,1,10))}const Z5=()=>{};function $5(t,n,c){var o=[],r="xx",e="",a="",m="",s="1ms",l="1ms",f=u5(),v=()=>Object.keys(f).filter(p=>!!f[p].part1).sort();o=v();function Y(p=1){if(!d[p]){var L=f[r]||{},q=p===1?L.part1:L.part2;!q||(d[p]=!0,setTimeout(()=>{var B=performance.now(),R="(error)";try{R=q(m)}catch(S){R=String(S);var T=/:(\d+:\d+)\)/.exec(S.stack||"");T&&(R=`(${T[1]}) ${R}`)}z(p,R,performance.now()-B),d[p]=!1}))}}var d=[!1,!1,!1];function C(p=""){p&&c(2,r=p),c(0,m=f[p].input)}function g(p){Y(1),Y(2)}function z(p,L,q){var B=`(${Math.round(q)}ms)`;p===1&&c(3,e=L),p===1&&c(5,s=B),p===2&&c(4,a=L),p===2&&c(6,l=B)}setTimeout(()=>{C(o[o.length-1]),g()},100);const V=p=>C(p);function Z(){e=this.value,c(3,e)}function b(){a=this.value,c(4,a)}function $(){m=this.value,c(0,m)}return t.$$.update=()=>{t.$$.dirty&1&&g()},[m,o,r,e,a,s,l,C,V,Z,b,$]}class U5 extends yn{constructor(n){super(),Wn(this,n,$5,z5,_n,{})}}new U5({target:document.querySelector(".app")});
