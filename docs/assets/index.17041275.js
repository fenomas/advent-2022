(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const a of e.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerpolicy&&(e.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?e.credentials="include":r.crossorigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function o(r){if(r.ep)return;r.ep=!0;const e=t(r);fetch(r.href,e)}})();function H(){}function An(c){return c()}function mn(){return Object.create(null)}function F(c){c.forEach(An)}function Cn(c){return typeof c=="function"}function $n(c,n){return c!=c?n==n:c!==n||c&&typeof c=="object"||typeof c=="function"}function Un(c){return Object.keys(c).length===0}function A(c,n){c.appendChild(n)}function hn(c,n,t){c.insertBefore(n,t||null)}function cn(c){c.parentNode&&c.parentNode.removeChild(c)}function _n(c,n){for(let t=0;t<c.length;t+=1)c[t]&&c[t].d(n)}function j(c){return document.createElement(c)}function x(c){return document.createTextNode(c)}function $(){return x(" ")}function P(c,n,t,o){return c.addEventListener(n,t,o),()=>c.removeEventListener(n,t,o)}function C(c,n,t){t==null?c.removeAttribute(n):c.getAttribute(n)!==t&&c.setAttribute(n,t)}function Sn(c){return Array.from(c.childNodes)}function E(c,n){n=""+n,c.wholeText!==n&&(c.data=n)}function X(c,n){c.value=n??""}function Tn(c,n,t,o){t===null?c.style.removeProperty(n):c.style.setProperty(n,t,o?"important":"")}function sn(c,n,t){c.classList[t?"add":"remove"](n)}let tn;function J(c){tn=c}const G=[],ln=[],y=[],fn=[],Vn=Promise.resolve();let I=!1;function Mn(){I||(I=!0,Vn.then(gn))}function K(c){y.push(c)}const k=new Set;let N=0;function gn(){const c=tn;do{for(;N<G.length;){const n=G[N];N++,J(n),Xn(n.$$)}for(J(null),G.length=0,N=0;ln.length;)ln.pop()();for(let n=0;n<y.length;n+=1){const t=y[n];k.has(t)||(k.add(t),t())}y.length=0}while(G.length);for(;fn.length;)fn.pop()();I=!1,k.clear(),J(c)}function Xn(c){if(c.fragment!==null){c.update(),F(c.before_update);const n=c.dirty;c.dirty=[-1],c.fragment&&c.fragment.p(c.ctx,n),c.after_update.forEach(K)}}const Fn=new Set;function Gn(c,n){c&&c.i&&(Fn.delete(c),c.i(n))}function Pn(c,n,t,o){const{fragment:r,after_update:e}=c.$$;r&&r.m(n,t),o||K(()=>{const a=c.$$.on_mount.map(An).filter(Cn);c.$$.on_destroy?c.$$.on_destroy.push(...a):F(a),c.$$.on_mount=[]}),e.forEach(K)}function Jn(c,n){const t=c.$$;t.fragment!==null&&(F(t.on_destroy),t.fragment&&t.fragment.d(n),t.on_destroy=t.fragment=null,t.ctx=[])}function Qn(c,n){c.$$.dirty[0]===-1&&(G.push(c),Mn(),c.$$.dirty.fill(0)),c.$$.dirty[n/31|0]|=1<<n%31}function Hn(c,n,t,o,r,e,a,m=[-1]){const s=tn;J(c);const l=c.$$={fragment:null,ctx:[],props:e,update:H,not_equal:r,bound:mn(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(n.context||(s?s.$$.context:[])),callbacks:mn(),dirty:m,skip_bound:!1,root:n.target||s.$$.root};a&&a(l.root);let f=!1;if(l.ctx=t?t(c,n.props||{},(v,Y,...d)=>{const h=d.length?d[0]:Y;return l.ctx&&r(l.ctx[v],l.ctx[v]=h)&&(!l.skip_bound&&l.bound[v]&&l.bound[v](h),f&&Qn(c,v)),Y}):[],l.update(),f=!0,F(l.before_update),l.fragment=o?o(l.ctx):!1,n.target){if(n.hydrate){const v=Sn(n.target);l.fragment&&l.fragment.l(v),v.forEach(cn)}else l.fragment&&l.fragment.c();n.intro&&Gn(c.$$.fragment),Pn(c,n.target,n.anchor,n.customElement),gn()}J(s)}class Nn{$destroy(){Jn(this,1),this.$destroy=H}$on(n,t){if(!Cn(t))return H;const o=this.$$.callbacks[n]||(this.$$.callbacks[n]=[]);return o.push(t),()=>{const r=o.indexOf(t);r!==-1&&o.splice(r,1)}}$set(n){this.$$set&&!Un(n)&&(this.$$.skip_bound=!0,this.$$set(n),this.$$.skip_bound=!1)}}function Wn(c=""){return Bn(c).reduce((n,t)=>Math.max(n,t),0)}function yn(c=""){for(var n=Bn(c).sort((r,e)=>e-r),t=0,o=0;o<Math.min(3,n.length);o++)t+=n[o];return t}function Bn(c){var n=[0];return c.split(`
`).forEach(t=>{t?n[n.length-1]+=parseInt(t):n.push(0)}),n}const xn=Object.freeze(Object.defineProperty({__proto__:null,part1:Wn,part2:yn},Symbol.toStringTag,{value:"Module"}));function On(c=""){var n={"A X":4,"B X":1,"C X":7,"A Y":8,"B Y":5,"C Y":2,"A Z":3,"B Z":9,"C Z":6};return c.split(`
`).map(t=>n[t]).reduce((t,o)=>t+o)}function kn(c=""){var n={"A X":3,"B X":1,"C X":2,"A Y":4,"B Y":5,"C Y":6,"A Z":8,"B Z":9,"C Z":7};return c.split(`
`).map(t=>n[t]).reduce((t,o)=>t+o)}const En=Object.freeze(Object.defineProperty({__proto__:null,part1:On,part2:kn},Symbol.toStringTag,{value:"Module"}));function In(c=""){var n=0;return c.split(`
`).forEach(t=>{t=t.trim();for(var o={},r=t.length/2,e=0;e<r;e++)o[t.charAt(e)]=!0;for(var a=r;a<t.length;a++)if(o[t.charAt(a)]){n+=bn(t,a);return}}),n}function Kn(c=""){var n,t,o=0;return c.split(`
`).forEach((r,e)=>{r=r.trim();var a=e%3;if(a===0){n={};for(var m of r)n[m]=!0}else if(a===1){t={};for(var m of r)n[m]&&(t[m]=!0)}else for(var m of r)if(t[m]){o+=bn(m,0);return}}),o}function bn(c,n){var t=c.charCodeAt(n);return t>95?t-96:t-38}const n1=Object.freeze(Object.defineProperty({__proto__:null,part1:In,part2:Kn},Symbol.toStringTag,{value:"Module"}));function c1(c=""){var n=0;return c.split(`
`).forEach(t=>{var[o,r]=t.split(","),[e,a]=o.split("-").map(l=>parseInt(l)),[m,s]=r.split("-").map(l=>parseInt(l));e<m&&s>a||m<e&&a>s||n++}),n}function t1(c=""){var n=0;return c.split(`
`).forEach(t=>{var[o,r]=t.split(","),[e,a]=o.split("-").map(l=>parseInt(l)),[m,s]=r.split("-").map(l=>parseInt(l));a<m||e>s||n++}),n}const r1=Object.freeze(Object.defineProperty({__proto__:null,part1:c1,part2:t1},Symbol.toStringTag,{value:"Module"}));function o1(c=""){var n=[];return c.split(`
`).forEach(t=>{if(t.includes("["))for(var o=1;o<t.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var e=t.charAt(o);e!==" "&&n[r].unshift(e)}if(t.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(t);if(!a)return;for(var m=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,o=0;o<m;o++){var f=n[s].pop();n[l].push(f)}}}),n.map(t=>t[t.length-1]).join("")}function a1(c=""){var n=[];return c.split(`
`).forEach(t=>{if(t.includes("["))for(var o=1;o<t.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var e=t.charAt(o);e!==" "&&n[r].unshift(e)}if(t.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(t);if(!a)return;var m=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,f=n[s],v=f.splice(f.length-m);n[l]=n[l].concat(v)}}),n.map(t=>t[t.length-1]).join("")}const e1=Object.freeze(Object.defineProperty({__proto__:null,part1:o1,part2:a1},Symbol.toStringTag,{value:"Module"}));function m1(c=""){return jn(c,4)}function s1(c=""){return jn(c,14)}function jn(c,n){for(var t=0,o=0;o<c.length;o++){if(t++,t===n)return o+1;for(var r=1;r<n-t+1;r++)if(c[o]===c[o+r]){t=0;break}}return-1}const l1=Object.freeze(Object.defineProperty({__proto__:null,part1:m1,part2:s1},Symbol.toStringTag,{value:"Module"}));function f1(c=""){var n=Ln(c),t=rn(n),o=0;return t.forEach(r=>{r.size<1e5&&(o+=r.size)}),o}function v1(c=""){var n=Ln(c),t=rn(n),o=7e7-n.size,r=3e7-o,e=1/0;return t.forEach(a=>{a.size>r&&a.size<e&&(e=a.size)}),e}function nn(c){this.parent=c,this.children={},this.size=0}function Y1(c="a",n="1"){this.name=c,this.size=parseInt(n)}function Ln(c){var n=new nn(null),t=n;return c.split(`
`).forEach(o=>{if(o=o.trim(),/^\$ cd /.test(o)){var r=o.substring(5);r==="/"?t=n:r===".."?t=t.parent:t=t.children[r]}else if(!/^\$ ls/.test(o))if(/^dir /.test(o)){var e=o.substring(4);t.children[e]=t.children[e]||new nn(t)}else if(/^\d+ \S+$/.test(o)){var[a,m]=o.split(" ");t.children[m]=t.children[m]||new Y1(m,a)}else console.log("err",o);if(!t)return console.log("err",t,n),""}),n}function rn(c,n=[]){n.push(c);var t=0;for(var o in c.children){var r=c.children[o];r instanceof nn&&rn(r,n),t+=r.size}return c.size=t,n}const d1=Object.freeze(Object.defineProperty({__proto__:null,part1:f1,part2:v1},Symbol.toStringTag,{value:"Module"}));function p1(c=""){var n=[];c.split(`
`).forEach((a,m)=>{n[m]=[],a.split("").forEach(s=>{var l=parseInt(s);n[m].push({ht:l,viz:!1})})});var t=(a,m=1)=>{for(var s=-1,l=0;l<a.length;l++){var f=m>0?a[l]:a[a.length-l-1];f.ht>s&&(f.viz=!0,s=f.ht)}};n.forEach(a=>t(a)),n.forEach(a=>t(a,-1));for(var o=0;o<n[0].length;o++){var r=n.map(a=>a[o]);t(r),t(r,-1)}var e=0;return n.forEach(a=>{a.forEach(m=>{m.viz&&e++})}),e}function A1(c=""){var n=[];c.split(`
`).forEach((a,m)=>{n[m]=[],a.split("").forEach(s=>{var l=parseInt(s);n[m].push({ht:l,score:1})})});var t=0,o=a=>{for(var m=0;m<a.length;m++){for(var s=a[m],l=0,f=m-1;f>=0;f--){var v=a[f];if(l++,v.ht>=s.ht)break}for(var Y=0,d=m+1;d<a.length;d++){var h=a[d];if(Y++,h.ht>=s.ht)break}s.score*=l,s.score*=Y,s.score>t&&(t=s.score)}};n.forEach(a=>o(a));for(var r=0;r<n[0].length;r++){var e=n.map(a=>a[r]);o(e)}return t}const C1=Object.freeze(Object.defineProperty({__proto__:null,part1:p1,part2:A1},Symbol.toStringTag,{value:"Module"}));function h1(c=""){var n=[0,0],t=[0,0],o={},r=a=>o[a.join(",")]=!0,e={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return r(t),c.split(`
`).forEach((a,m)=>{for(var[s,l]=a.trim().split(/\s+/),f=e[s],v=parseInt(l),Y=0;Y<v;Y++)n[0]+=f[0],n[1]+=f[1],wn(n,t),r(t)}),Object.keys(o).length}function wn(c,n){var t=c[0]-n[0],o=c[1]-n[1],r=c[0]>n[0]?1:-1,e=c[1]>n[1]?1:-1;t===0||o===0?(Math.abs(t)>1&&(n[0]+=r),Math.abs(o)>1&&(n[1]+=e)):(Math.abs(t)>1||Math.abs(o)>1)&&(n[0]+=r,n[1]+=e)}function i1(c=""){var n=Array.from(Array(10)).map(e=>[0,0]),t={},o=e=>t[e.join(",")]=!0,r={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return o(n[0]),c.split(`
`).forEach((e,a)=>{for(var[m,s]=e.trim().split(/\s+/),l=r[m],f=parseInt(s),v=0;v<f;v++){n[0][0]+=l[0],n[0][1]+=l[1];for(var a=1;a<n.length;a++)wn(n[a-1],n[a]);o(n[n.length-1])}}),Object.keys(t).length}const g1=Object.freeze(Object.defineProperty({__proto__:null,part1:h1,part2:i1},Symbol.toStringTag,{value:"Module"}));function B1(c=""){var n=0,t={20:!0,60:!0,100:!0,140:!0,180:!0,220:!0},o=(a,m)=>{a in t&&(n+=m*a)},r=1,e=1;return c.split(`
`).forEach(a=>{for(var[m,s]=a.trim().split(/\s+/),l=m==="addx"?2:1;l-- >0;)o(r,e),r++;m==="addx"&&(e+=parseInt(s))}),n}function b1(c=""){var n="",t=(e,a)=>{var m=(e-1)%40;m===0&&e>1&&(n+=`
`);var s=Math.abs(m-a);n+=s<2?"#":"."},o=1,r=1;return c.split(`
`).forEach(e=>{for(var[a,m]=e.trim().split(/\s+/),s=a==="addx"?2:1;s-- >0;)t(o,r),o++;a==="addx"&&(r+=parseInt(m))}),n}const j1=Object.freeze(Object.defineProperty({__proto__:null,part1:B1,part2:b1},Symbol.toStringTag,{value:"Module"}));function L1(){this.items=[],this.op=()=>{},this.div=1,this.next=[0,0],this.count=0}function Dn(c){var n=[],t=null;return c.split(`
`).forEach(o=>{var r=o.trim().split(/\s+/);if(r[0]==="Monkey")t=new L1,n.push(t);else if(r[0]==="Starting")t.items=r.slice(2).map(m=>parseInt(m));else if(r[0]==="Operation:"){var e=r.pop(),a=r.pop();t.op=(()=>{if(e==="old"){if(a==="+")return s=>s+s;if(a==="*")return s=>s*s;throw"unhandled"}var m=parseInt(e);if(!isNaN(m)){if(a==="+")return s=>s+m;if(a==="*")return s=>s*m}throw"unhandled"})()}else r[0]==="Test:"?t.div=parseInt(r.pop()):r[1]==="true:"?t.next[0]=parseInt(r.pop()):r[1]==="false:"&&(t.next[1]=parseInt(r.pop()))}),n}function w1(c=""){for(var n=Dn(c),t=0;t<20;t++)n.forEach(o=>{o.items.forEach(r=>{o.count++,r=o.op(r),r=Math.floor(r/3);var e=r%o.div===0?0:1,a=o.next[e];n[a].items.push(r)}),o.items=[]});return n.sort((o,r)=>r.count-o.count),n[0].count*n[1].count}function D1(c=""){for(var n=Dn(c),t=n.reduce((r,e)=>r*e.div,1),o=0;o<1e4;o++)n.forEach(r=>{r.items.forEach(e=>{r.count++,e=r.op(e),e=e%t;var a=e%r.div===0?0:1,m=r.next[a];n[m].items.push(e)}),r.items=[]});return n.sort((r,e)=>e.count-r.count),n[0].count*n[1].count}const q1=Object.freeze(Object.defineProperty({__proto__:null,part1:w1,part2:D1},Symbol.toStringTag,{value:"Module"}));function qn(c){var n=[-1,-1],t=[-1,-1],o=[];c.split(`
`).forEach((e,a)=>{var m=e.trim().split("").map((s,l)=>{var f=s.charCodeAt(0)-96,v=9999;return s==="S"&&(n=[l,a],f=1),s==="E"&&(t=[l,a],f=26),{ht:f,steps:v}});o.push(m)});var r=(e,a)=>e<0||e>=o[0].length||a<0||a>=o.length?null:o[a][e];return{start:n,end:t,getData:r}}function R1(c=""){var{start:n,end:t,getData:o}=qn(c);o(...n).steps=0;for(var r=[n],e=(l,f,v,Y)=>{var d=o(l,f);if(d){if(d.ht>v+1||d.steps<=Y)return;d.steps=Y,r.push([l,f])}};r.length>0;){var[a,m]=r.pop(),s=o(a,m);e(a-1,m,s.ht,s.steps+1),e(a+1,m,s.ht,s.steps+1),e(a,m-1,s.ht,s.steps+1),e(a,m+1,s.ht,s.steps+1)}return o(t[0],t[1]).steps}function u1(c=""){var{end:n,getData:t}=qn(c);t(...n).steps=0;for(var o=[n],r=9999,e=(l,f,v,Y)=>{var d=t(l,f);if(d){if(d.ht<v-1||d.steps<=Y)return;d.steps=Y,o.push([l,f]),d.ht===1&&(r=Math.min(r,d.steps))}};o.length>0;){var[a,m]=o.pop(),s=t(a,m);e(a-1,m,s.ht,s.steps+1),e(a+1,m,s.ht,s.steps+1),e(a,m-1,s.ht,s.steps+1),e(a,m+1,s.ht,s.steps+1)}return r}const z1=Object.freeze(Object.defineProperty({__proto__:null,part1:R1,part2:u1},Symbol.toStringTag,{value:"Module"}));function Z1(c=""){var n=c.split(`
`).map(o=>o.trim()).filter(o=>o).map(Rn),t=0;return n.forEach((o,r)=>{if(r%2!==0){var e=Q(n[r-1],o);e<0&&(t+=(r+1)/2)}}),t}function $1(c=""){c+=`
  [[2]]  
  [[6]] `;var n=c.split(`
`).map(o=>o.trim()).filter(o=>o).map(Rn).sort(Q),t=1;return n.forEach((o,r)=>{if(o.length===1&&o[0].length===1){var e=o[0][0];(e===2||e===6)&&(t*=r+1)}}),t}function Q(c,n){if(typeof c=="number")return typeof n=="number"?c-n:Q([c],n);if(typeof n=="number")return Q(c,[n]);for(var t=Math.min(c.length,n.length),o=0;o<t;o++){var r=Q(c[o],n[o]);if(r!==0)return r}return c.length-n.length}function Rn(c){if(c[0]!=="[")throw["err-1",c].join(" ");for(var n=[],t=[n],o=1;o<c.length-1;o++){var r=c[o];if(r!==","){if(r==="]"){t.pop();continue}var e=t[t.length-1];if(r==="["){var a=[];e.push(a),t.push(a);continue}var m=/^\d+/.exec(c.substring(o));if(!m)throw["err-2",o,c].join(" ");e.push(parseInt(m[0])),o+=m.length-1}}return n}const U1=Object.freeze(Object.defineProperty({__proto__:null,part1:Z1,part2:$1},Symbol.toStringTag,{value:"Module"}));function _1(c=""){for(var n=new un(c),t=0;t<99999;t++)if(n.sandComesToRestAt(500,0)>n.maxY)return t;throw"err"}function S1(c=""){for(var n=new un(c),t=0;t<99999;t++)if(n.sandComesToRestAt(500,0)<0)return t;throw"err"}function un(c){var n=[],t=-99999,a=99999,o=(m,s)=>{n[m]||(n[m]=[]),n[m][s]=!0,t=Math.max(t,s)},r=(m,s)=>s>=a?!0:n[m]&&n[m][s]||!1,e=(m,s,l,f)=>{for(var v=m===l?0:m<l?1:-1,Y=s===f?0:s<f?1:-1,d=Math.max(Math.abs(m-l),Math.abs(s-f)),h=0;h<=d;h++)o(m,s),m+=v,s+=Y};c.split(`
`).forEach(m=>{var s;m.split("->").forEach((l,f)=>{var v=l.split(",").map(Y=>parseInt(Y));s&&e(...s,...v),s=v})}),this.maxY=t;var a=t+2;this.sandComesToRestAt=(m,s)=>{if(r(m,s))return s-1;for(var l=0;l<99999;l++){if(!r(m,s+1)){s++;continue}if(!r(m-1,s+1)){m--,s++;continue}if(!r(m+1,s+1)){m++,s++;continue}return o(m,s),s}}}const T1=Object.freeze(Object.defineProperty({__proto__:null,part1:_1,part2:S1},Symbol.toStringTag,{value:"Module"}));function V1(c=""){var n=zn(c),t=2e6,o=1/0,r=-1/0;return n.forEach(({sx:e,sy:a,dist:m})=>{var s=m-Math.abs(a-t);s<0||(o=Math.min(o,e-s),r=Math.max(r,e+s))}),r-o}function M1(c=""){for(var n=zn(c),t=4e6,o=0;o<=t;o++)for(var r=0;r<=t;r++){var e=n.some(({sx:a,sy:m,dist:s})=>{var l=s-Math.abs(m-o);if(!(l<0)){var f=Math.abs(a-r);if(!(f>l))return r=a+l,!0}});if(!!e&&!(r>t))return 4e6*r+o}return"no hits"}function zn(c){return c.trim().split(`
`).map(n=>{var t=/Sensor at x=(.+), y=(.+): closest beacon is at x=(.+), y=(.+)/.exec(n.trim());if(!t)throw"?";var[,o,r,e,a]=t.map(s=>parseInt(s)),m=Math.abs(e-o)+Math.abs(a-r);return{sx:o,sy:r,dist:m}})}const X1=Object.freeze(Object.defineProperty({__proto__:null,part1:V1,part2:M1},Symbol.toStringTag,{value:"Module"}));function F1(c=""){var{rates:n,distances:t}=Zn(c),o=Object.keys(n).filter(v=>n[v]>0),r=[],e=(v,Y,d,h)=>{r.push({t:v,tot:Y,loc:d,done:h})},a=0;for(e(0,0,"AA","");r.length>0;){var{t:m,tot:s,loc:l,done:f}=r.pop();o.forEach(v=>{if(!f.includes(v)){var Y=m+t[l][v]+1;if(!(Y>=30)){var d=n[v]*(30-Y),h=s+d;h>a&&(a=h),e(Y,h,v,f+","+v)}}})}return a}function G1(c=""){var{rates:n,distances:t}=Zn(c),o=Object.keys(n).filter(B=>n[B]>0),r=[],e=(B,Z,p,w,R,g)=>{r.push({t1:B,t2:Z,tot:p,loc1:w,loc2:R,done:g}),r.length>5e3&&(r.sort((q,T)=>T.tot-q.tot),r.length=4e3)},a=0;e(4,4,0,"AA","AA","");for(var m=0;m<30;m++){var s=r;for(r=[];s.length>0;){var{t1:l,t2:f,tot:v,loc1:Y,loc2:d,done:h}=s.pop(),[L,_]=l<f?[l,f]:[f,l],[V,z]=l<f?[Y,d]:[d,Y];o.forEach(B=>{if(!h.includes(B)){var Z=L+t[V][B]+1;if(!(Z>=30)){var p=n[B]*(30-Z),w=v+p,R=h+","+B;w>a&&(a=w),e(_,Z,w,z,B,R)}}})}}return a}function Zn(c){var n={},t={},o={};c.trim().split(`
`).forEach(e=>{var a=/Valve (.+) has flow rate=(.+); tunnels? leads? to valves? (.+)/.exec(e.trim());if(!a)throw`?? ${e}`;var[,m,s,l]=a;n[m]=parseInt(s),t[m]=l.split(",").map(f=>f.trim()),o[m]={}});var r=(e,a,m)=>{var s=o[e][a]||999;s<=m||(o[e][a]=m,t[a].forEach(l=>r(e,l,m+1)))};return Object.keys(n).forEach(e=>r(e,e,0)),{rates:n,distances:o}}const P1=Object.freeze(Object.defineProperty({__proto__:null,part1:F1,part2:G1},Symbol.toStringTag,{value:"Module"})),J1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),Q1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),H1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),N1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),W1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),y1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),x1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),O1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),k1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),E1=`5557
6663
3952
4750
2271
...
cjlhShjchhjGGmNVjplcQgmTPtHPPJmQgQHgtqgZ`,n5=`8-82,3-96
13-95,99-99
4-92,5-93
16-80,16-80
23-36,6-10
...
move 2 from 4 to 6
move 1 from 4 to 7
move 6 from 1 to 8`,t5="",r5=`$ cd /
$ ls
dir bqc
dir mwmlf
dir ngn
...
$ cd zdqprndl
$ ls
197398 tprth.gjn`,o5=`200111110420341122211300354132530435302054046335421000636521353401523010501311544011230232023001001
...
202312021141114142554431112520342120400556304244541024562551661211241403030453530144444200321002011`,a5=`U 1
D 2
U 1
L 1
R 1
...
Monkey 7:
  ...
  Test: divisible by 7
    ...
    If false: throw to monkey 0`,s5=`abcccccccccaaaaaaaaaaccccccccccccaaaaaaaaccaaccccccccccccccccccccccccccccccccccccccccccccaaaaaa
...
abccccccccccccccccccccaaaaacccaaaaaaaaaaaacccccccccaacaacccccccccccccccccccccccccccccccccaaaaaa`,l5=`[[[[8,6]],[8,[7],[6,7,6,2,4]],10,[[1,7,9],7,[7,9]]],[[4,[],[10,5],[5,4,7],5],8,9,[[5,3,3,6,9],[9,5,10],8],[[0,6,9],[8],4,6,8]]]
...
[[7,[]]]
[[[],9,[[0,9,1],[6],9,[8,4,10,4,7],[6]]],[3,[2,[0,5],7,9],2],[[[9],7,[1,7],9]]]`,f5=`495,144 -> 499,144
...
507,181 -> 507,171 -> 507,181 -> 509,181 -> 509,173 -> 509,181 -> 511,181 -> 511,176 -> 511,181 -> 513,181 -> 513,176 -> 513,181
499,13 -> 499,17 -> 497,17 -> 497,25 -> 505,25 -> 505,17 -> 502,17 -> 502,13
500,158 -> 500,159 -> 513,159`,v5=`Sensor at x=3907621, y=2895218: closest beacon is at x=3790542, y=2949630
...
Sensor at x=2194423, y=3990859: closest beacon is at x=2275951, y=3717327`,Y5=`Valve EJ has flow rate=25; tunnel leads to valve MC
...
Valve UI has flow rate=0; tunnels lead to valves AR, CB`,d5="",p5="",A5="",C5="",h5="",i5="",g5="",B5="",b5="";var vn=Object.assign({"./solutions/solution-01.js":xn,"./solutions/solution-02.js":En,"./solutions/solution-03.js":n1,"./solutions/solution-04.js":r1,"./solutions/solution-05.js":e1,"./solutions/solution-06.js":l1,"./solutions/solution-07.js":d1,"./solutions/solution-08.js":C1,"./solutions/solution-09.js":g1,"./solutions/solution-10.js":j1,"./solutions/solution-11.js":q1,"./solutions/solution-12.js":z1,"./solutions/solution-13.js":U1,"./solutions/solution-14.js":T1,"./solutions/solution-15.js":X1,"./solutions/solution-16.js":P1,"./solutions/solution-17.js":J1,"./solutions/solution-18.js":Q1,"./solutions/solution-19.js":H1,"./solutions/solution-20.js":N1,"./solutions/solution-21.js":W1,"./solutions/solution-22.js":y1,"./solutions/solution-23.js":x1,"./solutions/solution-24.js":O1,"./solutions/solution-25.js":k1}),Yn=Object.assign({"./inputs/input-01.txt":E1,"./inputs/input-02.txt":I1,"./inputs/input-03.txt":K1,"./inputs/input-04.txt":n5,"./inputs/input-05.txt":c5,"./inputs/input-06.txt":t5,"./inputs/input-07.txt":r5,"./inputs/input-08.txt":o5,"./inputs/input-09.txt":a5,"./inputs/input-10.txt":e5,"./inputs/input-11.txt":m5,"./inputs/input-12.txt":s5,"./inputs/input-13.txt":l5,"./inputs/input-14.txt":f5,"./inputs/input-15.txt":v5,"./inputs/input-16.txt":Y5,"./inputs/input-17.txt":d5,"./inputs/input-18.txt":p5,"./inputs/input-19.txt":A5,"./inputs/input-20.txt":C5,"./inputs/input-21.txt":h5,"./inputs/input-22.txt":i5,"./inputs/input-23.txt":g5,"./inputs/input-24.txt":B5,"./inputs/input-25.txt":b5});function j5(c,n,t){this.day=c||"0",this.input=n||"",this.part1=t.part1||null,this.part2=t.part2||null}function L5(){var c={},n={};Object.keys(Yn).forEach(r=>{var e=/input-(..)/.exec(r)[1];c[e]=Yn[r]||""}),Object.keys(vn).forEach(r=>{var e=/solution-(..)/.exec(r)[1];n[e]=vn[r]||null});var t={},o=Object.keys(c).sort();return o.forEach(r=>{t[r]=new j5(r,c[r],n[r])}),t}function dn(c,n,t){const o=c.slice();return o[18]=n[t],o}function pn(c){let n,t=c[18]+"",o,r,e;function a(){return c[8](c[18])}return{c(){n=j("span"),o=x(t),C(n,"class","button svelte-1cclp05"),sn(n,"current",c[18]===c[2])},m(m,s){hn(m,n,s),A(n,o),r||(e=[P(n,"keydown",D5),P(n,"click",a)],r=!0)},p(m,s){c=m,s&2&&t!==(t=c[18]+"")&&E(o,t),s&6&&sn(n,"current",c[18]===c[2])},d(m){m&&cn(n),r=!1,F(e)}}}function w5(c){let n,t,o,r,e,a,m,s,l,f,v,Y,d,h,L,_,V,z,B,Z,p,w,R,g,q,T,S,on,U,O,an,M=c[1],D=[];for(let i=0;i<M.length;i+=1)D[i]=pn(dn(c,M,i));return{c(){n=j("div"),t=j("h2"),t.textContent="Advent 2022",o=$(),r=j("div"),e=j("div"),e.innerHTML='<h4 class="svelte-1cclp05">Days:</h4>',a=$(),m=j("div");for(let i=0;i<D.length;i+=1)D[i].c();s=$(),l=j("div"),f=j("h4"),f.textContent="Output 1:",v=$(),Y=j("div"),d=x(c[5]),h=$(),L=j("textarea"),V=$(),z=j("div"),B=j("h4"),B.textContent="Output 2:",Z=$(),p=j("div"),w=x(c[6]),R=$(),g=j("textarea"),T=$(),S=j("div"),S.innerHTML='<h4 class="svelte-1cclp05">Input:</h4>',on=$(),U=j("textarea"),C(e,"class","label svelte-1cclp05"),C(m,"class","day-list"),C(f,"class","svelte-1cclp05"),C(Y,"class","time svelte-1cclp05"),C(l,"class","label svelte-1cclp05"),C(L,"name","output1"),C(L,"id","output1"),C(L,"rows",_=W(c[3])),C(L,"class","svelte-1cclp05"),C(B,"class","svelte-1cclp05"),C(p,"class","time svelte-1cclp05"),C(z,"class","label svelte-1cclp05"),C(g,"name","output2"),C(g,"id","output2"),C(g,"rows",q=W(c[4])),C(g,"class","svelte-1cclp05"),C(S,"class","label svelte-1cclp05"),Tn(S,"align-self","flex-start"),C(U,"name","input"),C(U,"id","input"),C(U,"rows","14"),C(U,"class","svelte-1cclp05"),C(r,"class","layout svelte-1cclp05"),C(n,"class","outer svelte-1cclp05")},m(i,u){hn(i,n,u),A(n,t),A(n,o),A(n,r),A(r,e),A(r,a),A(r,m);for(let b=0;b<D.length;b+=1)D[b].m(m,null);A(r,s),A(r,l),A(l,f),A(l,v),A(l,Y),A(Y,d),A(r,h),A(r,L),X(L,c[3]),A(r,V),A(r,z),A(z,B),A(z,Z),A(z,p),A(p,w),A(r,R),A(r,g),X(g,c[4]),A(r,T),A(r,S),A(r,on),A(r,U),X(U,c[0]),O||(an=[P(L,"input",c[9]),P(g,"input",c[10]),P(U,"input",c[11])],O=!0)},p(i,[u]){if(u&134){M=i[1];let b;for(b=0;b<M.length;b+=1){const en=dn(i,M,b);D[b]?D[b].p(en,u):(D[b]=pn(en),D[b].c(),D[b].m(m,null))}for(;b<D.length;b+=1)D[b].d(1);D.length=M.length}u&32&&E(d,i[5]),u&8&&_!==(_=W(i[3]))&&C(L,"rows",_),u&8&&X(L,i[3]),u&64&&E(w,i[6]),u&16&&q!==(q=W(i[4]))&&C(g,"rows",q),u&16&&X(g,i[4]),u&1&&X(U,i[0])},i:H,o:H,d(i){i&&cn(n),_n(D,i),O=!1,F(an)}}}function W(c){var n=String(c||"").split(`
`).length;return Math.min(n,Math.max(n,1,10))}const D5=()=>{};function q5(c,n,t){var o=[],r="xx",e="",a="",m="",s="1ms",l="1ms",f=L5(),v=()=>Object.keys(f).filter(p=>!!f[p].part1).sort();o=v();function Y(p=1){if(!d[p]){var w=f[r]||{},R=p===1?w.part1:w.part2;!R||(d[p]=!0,setTimeout(()=>{var g=performance.now(),q="(error)";try{q=R(m)}catch(S){q=String(S);var T=/:(\d+:\d+)\)/.exec(S.stack||"");T&&(q=`(${T[1]}) ${q}`)}_(p,q,performance.now()-g),d[p]=!1}))}}var d=[!1,!1,!1];function h(p=""){p&&t(2,r=p),t(0,m=f[p].input)}function L(p){Y(1),Y(2)}function _(p,w,R){var g=`(${Math.round(R)}ms)`;p===1&&t(3,e=w),p===1&&t(5,s=g),p===2&&t(4,a=w),p===2&&t(6,l=g)}setTimeout(()=>{h(o[o.length-1]),L()},100);const V=p=>h(p);function z(){e=this.value,t(3,e)}function B(){a=this.value,t(4,a)}function Z(){m=this.value,t(0,m)}return c.$$.update=()=>{c.$$.dirty&1&&L()},[m,o,r,e,a,s,l,h,V,z,B,Z]}class R5 extends Nn{constructor(n){super(),Hn(this,n,q5,w5,$n,{})}}new R5({target:document.querySelector(".app")});
