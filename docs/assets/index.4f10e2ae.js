(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const m of r)if(m.type==="childList")for(const a of m.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function c(r){const m={};return r.integrity&&(m.integrity=r.integrity),r.referrerpolicy&&(m.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?m.credentials="include":r.crossorigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function o(r){if(r.ep)return;r.ep=!0;const m=c(r);fetch(r.href,m)}})();function H(){}function Cn(t){return t()}function mn(){return Object.create(null)}function F(t){t.forEach(Cn)}function hn(t){return typeof t=="function"}function Sn(t,n){return t!=t?n==n:t!==n||t&&typeof t=="object"||typeof t=="function"}function Tn(t){return Object.keys(t).length===0}function C(t,n){t.appendChild(n)}function gn(t,n,c){t.insertBefore(n,c||null)}function cn(t){t.parentNode&&t.parentNode.removeChild(t)}function Vn(t,n){for(let c=0;c<t.length;c+=1)t[c]&&t[c].d(n)}function w(t){return document.createElement(t)}function x(t){return document.createTextNode(t)}function U(){return x(" ")}function P(t,n,c,o){return t.addEventListener(n,c,o),()=>t.removeEventListener(n,c,o)}function h(t,n,c){c==null?t.removeAttribute(n):t.getAttribute(n)!==c&&t.setAttribute(n,c)}function Mn(t){return Array.from(t.childNodes)}function I(t,n){n=""+n,t.wholeText!==n&&(t.data=n)}function X(t,n){t.value=n??""}function Xn(t,n,c,o){c===null?t.style.removeProperty(n):t.style.setProperty(n,c,o?"important":"")}function sn(t,n,c){t.classList[c?"add":"remove"](n)}let tn;function J(t){tn=t}const G=[],ln=[],y=[],fn=[],Fn=Promise.resolve();let E=!1;function Gn(){E||(E=!0,Fn.then(Bn))}function K(t){y.push(t)}const O=new Set;let N=0;function Bn(){const t=tn;do{for(;N<G.length;){const n=G[N];N++,J(n),Pn(n.$$)}for(J(null),G.length=0,N=0;ln.length;)ln.pop()();for(let n=0;n<y.length;n+=1){const c=y[n];O.has(c)||(O.add(c),c())}y.length=0}while(G.length);for(;fn.length;)fn.pop()();E=!1,O.clear(),J(t)}function Pn(t){if(t.fragment!==null){t.update(),F(t.before_update);const n=t.dirty;t.dirty=[-1],t.fragment&&t.fragment.p(t.ctx,n),t.after_update.forEach(K)}}const Jn=new Set;function Qn(t,n){t&&t.i&&(Jn.delete(t),t.i(n))}function Hn(t,n,c,o){const{fragment:r,after_update:m}=t.$$;r&&r.m(n,c),o||K(()=>{const a=t.$$.on_mount.map(Cn).filter(hn);t.$$.on_destroy?t.$$.on_destroy.push(...a):F(a),t.$$.on_mount=[]}),m.forEach(K)}function Nn(t,n){const c=t.$$;c.fragment!==null&&(F(c.on_destroy),c.fragment&&c.fragment.d(n),c.on_destroy=c.fragment=null,c.ctx=[])}function Wn(t,n){t.$$.dirty[0]===-1&&(G.push(t),Gn(),t.$$.dirty.fill(0)),t.$$.dirty[n/31|0]|=1<<n%31}function yn(t,n,c,o,r,m,a,e=[-1]){const s=tn;J(t);const l=t.$$={fragment:null,ctx:[],props:m,update:H,not_equal:r,bound:mn(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(n.context||(s?s.$$.context:[])),callbacks:mn(),dirty:e,skip_bound:!1,root:n.target||s.$$.root};a&&a(l.root);let f=!1;if(l.ctx=c?c(t,n.props||{},(Y,d,...v)=>{const p=v.length?v[0]:d;return l.ctx&&r(l.ctx[Y],l.ctx[Y]=p)&&(!l.skip_bound&&l.bound[Y]&&l.bound[Y](p),f&&Wn(t,Y)),d}):[],l.update(),f=!0,F(l.before_update),l.fragment=o?o(l.ctx):!1,n.target){if(n.hydrate){const Y=Mn(n.target);l.fragment&&l.fragment.l(Y),Y.forEach(cn)}else l.fragment&&l.fragment.c();n.intro&&Qn(t.$$.fragment),Hn(t,n.target,n.anchor,n.customElement),Bn()}J(s)}class xn{$destroy(){Nn(this,1),this.$destroy=H}$on(n,c){if(!hn(c))return H;const o=this.$$.callbacks[n]||(this.$$.callbacks[n]=[]);return o.push(c),()=>{const r=o.indexOf(c);r!==-1&&o.splice(r,1)}}$set(n){this.$$set&&!Tn(n)&&(this.$$.skip_bound=!0,this.$$set(n),this.$$.skip_bound=!1)}}function kn(t=""){return bn(t).reduce((n,c)=>Math.max(n,c),0)}function On(t=""){for(var n=bn(t).sort((r,m)=>m-r),c=0,o=0;o<Math.min(3,n.length);o++)c+=n[o];return c}function bn(t){var n=[0];return t.split(`
`).forEach(c=>{c?n[n.length-1]+=parseInt(c):n.push(0)}),n}const In=Object.freeze(Object.defineProperty({__proto__:null,part1:kn,part2:On},Symbol.toStringTag,{value:"Module"}));function En(t=""){var n={"A X":4,"B X":1,"C X":7,"A Y":8,"B Y":5,"C Y":2,"A Z":3,"B Z":9,"C Z":6};return t.split(`
`).map(c=>n[c]).reduce((c,o)=>c+o)}function Kn(t=""){var n={"A X":3,"B X":1,"C X":2,"A Y":4,"B Y":5,"C Y":6,"A Z":8,"B Z":9,"C Z":7};return t.split(`
`).map(c=>n[c]).reduce((c,o)=>c+o)}const n1=Object.freeze(Object.defineProperty({__proto__:null,part1:En,part2:Kn},Symbol.toStringTag,{value:"Module"}));function c1(t=""){var n=0;return t.split(`
`).forEach(c=>{c=c.trim();for(var o={},r=c.length/2,m=0;m<r;m++)o[c.charAt(m)]=!0;for(var a=r;a<c.length;a++)if(o[c.charAt(a)]){n+=jn(c,a);return}}),n}function t1(t=""){var n,c,o=0;return t.split(`
`).forEach((r,m)=>{r=r.trim();var a=m%3;if(a===0){n={};for(var e of r)n[e]=!0}else if(a===1){c={};for(var e of r)n[e]&&(c[e]=!0)}else for(var e of r)if(c[e]){o+=jn(e,0);return}}),o}function jn(t,n){var c=t.charCodeAt(n);return c>95?c-96:c-38}const r1=Object.freeze(Object.defineProperty({__proto__:null,part1:c1,part2:t1},Symbol.toStringTag,{value:"Module"}));function o1(t=""){var n=0;return t.split(`
`).forEach(c=>{var[o,r]=c.split(","),[m,a]=o.split("-").map(l=>parseInt(l)),[e,s]=r.split("-").map(l=>parseInt(l));m<e&&s>a||e<m&&a>s||n++}),n}function a1(t=""){var n=0;return t.split(`
`).forEach(c=>{var[o,r]=c.split(","),[m,a]=o.split("-").map(l=>parseInt(l)),[e,s]=r.split("-").map(l=>parseInt(l));a<e||m>s||n++}),n}const e1=Object.freeze(Object.defineProperty({__proto__:null,part1:o1,part2:a1},Symbol.toStringTag,{value:"Module"}));function m1(t=""){var n=[];return t.split(`
`).forEach(c=>{if(c.includes("["))for(var o=1;o<c.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var m=c.charAt(o);m!==" "&&n[r].unshift(m)}if(c.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(c);if(!a)return;for(var e=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,o=0;o<e;o++){var f=n[s].pop();n[l].push(f)}}}),n.map(c=>c[c.length-1]).join("")}function s1(t=""){var n=[];return t.split(`
`).forEach(c=>{if(c.includes("["))for(var o=1;o<c.length;o+=4){var r=(o-1)/4;n[r]||(n[r]=[]);var m=c.charAt(o);m!==" "&&n[r].unshift(m)}if(c.includes("move")){var a=/move (\d+) from (\d+) to (\d+)/.exec(c);if(!a)return;var e=parseInt(a[1]),s=parseInt(a[2])-1,l=parseInt(a[3])-1,f=n[s],Y=f.splice(f.length-e);n[l]=n[l].concat(Y)}}),n.map(c=>c[c.length-1]).join("")}const l1=Object.freeze(Object.defineProperty({__proto__:null,part1:m1,part2:s1},Symbol.toStringTag,{value:"Module"}));function f1(t=""){return wn(t,4)}function v1(t=""){return wn(t,14)}function wn(t,n){for(var c=0,o=0;o<t.length;o++){if(c++,c===n)return o+1;for(var r=1;r<n-c+1;r++)if(t[o]===t[o+r]){c=0;break}}return-1}const Y1=Object.freeze(Object.defineProperty({__proto__:null,part1:f1,part2:v1},Symbol.toStringTag,{value:"Module"}));function d1(t=""){var n=Ln(t),c=rn(n),o=0;return c.forEach(r=>{r.size<1e5&&(o+=r.size)}),o}function p1(t=""){var n=Ln(t),c=rn(n),o=7e7-n.size,r=3e7-o,m=1/0;return c.forEach(a=>{a.size>r&&a.size<m&&(m=a.size)}),m}function nn(t){this.parent=t,this.children={},this.size=0}function A1(t="a",n="1"){this.name=t,this.size=parseInt(n)}function Ln(t){var n=new nn(null),c=n;return t.split(`
`).forEach(o=>{if(o=o.trim(),/^\$ cd /.test(o)){var r=o.substring(5);r==="/"?c=n:r===".."?c=c.parent:c=c.children[r]}else if(!/^\$ ls/.test(o))if(/^dir /.test(o)){var m=o.substring(4);c.children[m]=c.children[m]||new nn(c)}else if(/^\d+ \S+$/.test(o)){var[a,e]=o.split(" ");c.children[e]=c.children[e]||new A1(e,a)}else console.log("err",o);if(!c)return console.log("err",c,n),""}),n}function rn(t,n=[]){n.push(t);var c=0;for(var o in t.children){var r=t.children[o];r instanceof nn&&rn(r,n),c+=r.size}return t.size=c,n}const C1=Object.freeze(Object.defineProperty({__proto__:null,part1:d1,part2:p1},Symbol.toStringTag,{value:"Module"}));function h1(t=""){var n=[];t.split(`
`).forEach((a,e)=>{n[e]=[],a.split("").forEach(s=>{var l=parseInt(s);n[e].push({ht:l,viz:!1})})});var c=(a,e=1)=>{for(var s=-1,l=0;l<a.length;l++){var f=e>0?a[l]:a[a.length-l-1];f.ht>s&&(f.viz=!0,s=f.ht)}};n.forEach(a=>c(a)),n.forEach(a=>c(a,-1));for(var o=0;o<n[0].length;o++){var r=n.map(a=>a[o]);c(r),c(r,-1)}var m=0;return n.forEach(a=>{a.forEach(e=>{e.viz&&m++})}),m}function i1(t=""){var n=[];t.split(`
`).forEach((a,e)=>{n[e]=[],a.split("").forEach(s=>{var l=parseInt(s);n[e].push({ht:l,score:1})})});var c=0,o=a=>{for(var e=0;e<a.length;e++){for(var s=a[e],l=0,f=e-1;f>=0;f--){var Y=a[f];if(l++,Y.ht>=s.ht)break}for(var d=0,v=e+1;v<a.length;v++){var p=a[v];if(d++,p.ht>=s.ht)break}s.score*=l,s.score*=d,s.score>c&&(c=s.score)}};n.forEach(a=>o(a));for(var r=0;r<n[0].length;r++){var m=n.map(a=>a[r]);o(m)}return c}const g1=Object.freeze(Object.defineProperty({__proto__:null,part1:h1,part2:i1},Symbol.toStringTag,{value:"Module"}));function B1(t=""){var n=[0,0],c=[0,0],o={},r=a=>o[a.join(",")]=!0,m={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return r(c),t.split(`
`).forEach((a,e)=>{for(var[s,l]=a.trim().split(/\s+/),f=m[s],Y=parseInt(l),d=0;d<Y;d++)n[0]+=f[0],n[1]+=f[1],Dn(n,c),r(c)}),Object.keys(o).length}function Dn(t,n){var c=t[0]-n[0],o=t[1]-n[1],r=t[0]>n[0]?1:-1,m=t[1]>n[1]?1:-1;c===0||o===0?(Math.abs(c)>1&&(n[0]+=r),Math.abs(o)>1&&(n[1]+=m)):(Math.abs(c)>1||Math.abs(o)>1)&&(n[0]+=r,n[1]+=m)}function b1(t=""){var n=Array.from(Array(10)).map(m=>[0,0]),c={},o=m=>c[m.join(",")]=!0,r={R:[1,0],L:[-1,0],U:[0,1],D:[0,-1]};return o(n[0]),t.split(`
`).forEach((m,a)=>{for(var[e,s]=m.trim().split(/\s+/),l=r[e],f=parseInt(s),Y=0;Y<f;Y++){n[0][0]+=l[0],n[0][1]+=l[1];for(var a=1;a<n.length;a++)Dn(n[a-1],n[a]);o(n[n.length-1])}}),Object.keys(c).length}const j1=Object.freeze(Object.defineProperty({__proto__:null,part1:B1,part2:b1},Symbol.toStringTag,{value:"Module"}));function w1(t=""){var n=0,c={20:!0,60:!0,100:!0,140:!0,180:!0,220:!0},o=(a,e)=>{a in c&&(n+=e*a)},r=1,m=1;return t.split(`
`).forEach(a=>{for(var[e,s]=a.trim().split(/\s+/),l=e==="addx"?2:1;l-- >0;)o(r,m),r++;e==="addx"&&(m+=parseInt(s))}),n}function L1(t=""){var n="",c=(m,a)=>{var e=(m-1)%40;e===0&&m>1&&(n+=`
`);var s=Math.abs(e-a);n+=s<2?"#":"."},o=1,r=1;return t.split(`
`).forEach(m=>{for(var[a,e]=m.trim().split(/\s+/),s=a==="addx"?2:1;s-- >0;)c(o,r),o++;a==="addx"&&(r+=parseInt(e))}),n}const D1=Object.freeze(Object.defineProperty({__proto__:null,part1:w1,part2:L1},Symbol.toStringTag,{value:"Module"}));function R1(){this.items=[],this.op=()=>{},this.div=1,this.next=[0,0],this.count=0}function Rn(t){var n=[],c=null;return t.split(`
`).forEach(o=>{var r=o.trim().split(/\s+/);if(r[0]==="Monkey")c=new R1,n.push(c);else if(r[0]==="Starting")c.items=r.slice(2).map(e=>parseInt(e));else if(r[0]==="Operation:"){var m=r.pop(),a=r.pop();c.op=(()=>{if(m==="old"){if(a==="+")return s=>s+s;if(a==="*")return s=>s*s;throw"unhandled"}var e=parseInt(m);if(!isNaN(e)){if(a==="+")return s=>s+e;if(a==="*")return s=>s*e}throw"unhandled"})()}else r[0]==="Test:"?c.div=parseInt(r.pop()):r[1]==="true:"?c.next[0]=parseInt(r.pop()):r[1]==="false:"&&(c.next[1]=parseInt(r.pop()))}),n}function q1(t=""){for(var n=Rn(t),c=0;c<20;c++)n.forEach(o=>{o.items.forEach(r=>{o.count++,r=o.op(r),r=Math.floor(r/3);var m=r%o.div===0?0:1,a=o.next[m];n[a].items.push(r)}),o.items=[]});return n.sort((o,r)=>r.count-o.count),n[0].count*n[1].count}function u1(t=""){for(var n=Rn(t),c=n.reduce((r,m)=>r*m.div,1),o=0;o<1e4;o++)n.forEach(r=>{r.items.forEach(m=>{r.count++,m=r.op(m),m=m%c;var a=m%r.div===0?0:1,e=r.next[a];n[e].items.push(m)}),r.items=[]});return n.sort((r,m)=>m.count-r.count),n[0].count*n[1].count}const z1=Object.freeze(Object.defineProperty({__proto__:null,part1:q1,part2:u1},Symbol.toStringTag,{value:"Module"}));function qn(t){var n=[-1,-1],c=[-1,-1],o=[];t.split(`
`).forEach((m,a)=>{var e=m.trim().split("").map((s,l)=>{var f=s.charCodeAt(0)-96,Y=9999;return s==="S"&&(n=[l,a],f=1),s==="E"&&(c=[l,a],f=26),{ht:f,steps:Y}});o.push(e)});var r=(m,a)=>m<0||m>=o[0].length||a<0||a>=o.length?null:o[a][m];return{start:n,end:c,getData:r}}function Z1(t=""){var{start:n,end:c,getData:o}=qn(t);o(...n).steps=0;for(var r=[n],m=(l,f,Y,d)=>{var v=o(l,f);if(v){if(v.ht>Y+1||v.steps<=d)return;v.steps=d,r.push([l,f])}};r.length>0;){var[a,e]=r.pop(),s=o(a,e);m(a-1,e,s.ht,s.steps+1),m(a+1,e,s.ht,s.steps+1),m(a,e-1,s.ht,s.steps+1),m(a,e+1,s.ht,s.steps+1)}return o(c[0],c[1]).steps}function $1(t=""){var{end:n,getData:c}=qn(t);c(...n).steps=0;for(var o=[n],r=9999,m=(l,f,Y,d)=>{var v=c(l,f);if(v){if(v.ht<Y-1||v.steps<=d)return;v.steps=d,o.push([l,f]),v.ht===1&&(r=Math.min(r,v.steps))}};o.length>0;){var[a,e]=o.pop(),s=c(a,e);m(a-1,e,s.ht,s.steps+1),m(a+1,e,s.ht,s.steps+1),m(a,e-1,s.ht,s.steps+1),m(a,e+1,s.ht,s.steps+1)}return r}const U1=Object.freeze(Object.defineProperty({__proto__:null,part1:Z1,part2:$1},Symbol.toStringTag,{value:"Module"}));function _1(t=""){var n=t.split(`
`).map(o=>o.trim()).filter(o=>o).map(un),c=0;return n.forEach((o,r)=>{if(r%2!==0){var m=Q(n[r-1],o);m<0&&(c+=(r+1)/2)}}),c}function S1(t=""){t+=`
  [[2]]  
  [[6]] `;var n=t.split(`
`).map(o=>o.trim()).filter(o=>o).map(un).sort(Q),c=1;return n.forEach((o,r)=>{if(o.length===1&&o[0].length===1){var m=o[0][0];(m===2||m===6)&&(c*=r+1)}}),c}function Q(t,n){if(typeof t=="number")return typeof n=="number"?t-n:Q([t],n);if(typeof n=="number")return Q(t,[n]);for(var c=Math.min(t.length,n.length),o=0;o<c;o++){var r=Q(t[o],n[o]);if(r!==0)return r}return t.length-n.length}function un(t){if(t[0]!=="[")throw["err-1",t].join(" ");for(var n=[],c=[n],o=1;o<t.length-1;o++){var r=t[o];if(r!==","){if(r==="]"){c.pop();continue}var m=c[c.length-1];if(r==="["){var a=[];m.push(a),c.push(a);continue}var e=/^\d+/.exec(t.substring(o));if(!e)throw["err-2",o,t].join(" ");m.push(parseInt(e[0])),o+=e.length-1}}return n}const T1=Object.freeze(Object.defineProperty({__proto__:null,part1:_1,part2:S1},Symbol.toStringTag,{value:"Module"}));function V1(t=""){for(var n=new zn(t),c=0;c<99999;c++)if(n.sandComesToRestAt(500,0)>n.maxY)return c;throw"err"}function M1(t=""){for(var n=new zn(t),c=0;c<99999;c++)if(n.sandComesToRestAt(500,0)<0)return c;throw"err"}function zn(t){var n=[],c=-99999,a=99999,o=(e,s)=>{n[e]||(n[e]=[]),n[e][s]=!0,c=Math.max(c,s)},r=(e,s)=>s>=a?!0:n[e]&&n[e][s]||!1,m=(e,s,l,f)=>{for(var Y=e===l?0:e<l?1:-1,d=s===f?0:s<f?1:-1,v=Math.max(Math.abs(e-l),Math.abs(s-f)),p=0;p<=v;p++)o(e,s),e+=Y,s+=d};t.split(`
`).forEach(e=>{var s;e.split("->").forEach((l,f)=>{var Y=l.split(",").map(d=>parseInt(d));s&&m(...s,...Y),s=Y})}),this.maxY=c;var a=c+2;this.sandComesToRestAt=(e,s)=>{if(r(e,s))return s-1;for(var l=0;l<99999;l++){if(!r(e,s+1)){s++;continue}if(!r(e-1,s+1)){e--,s++;continue}if(!r(e+1,s+1)){e++,s++;continue}return o(e,s),s}}}const X1=Object.freeze(Object.defineProperty({__proto__:null,part1:V1,part2:M1},Symbol.toStringTag,{value:"Module"}));function F1(t=""){var n=Zn(t),c=2e6,o=1/0,r=-1/0;return n.forEach(({sx:m,sy:a,dist:e})=>{var s=e-Math.abs(a-c);s<0||(o=Math.min(o,m-s),r=Math.max(r,m+s))}),r-o}function G1(t=""){for(var n=Zn(t),c=4e6,o=0;o<=c;o++)for(var r=0;r<=c;r++){var m=n.some(({sx:a,sy:e,dist:s})=>{var l=s-Math.abs(e-o);if(!(l<0)){var f=Math.abs(a-r);if(!(f>l))return r=a+l,!0}});if(!!m&&!(r>c))return 4e6*r+o}return"no hits"}function Zn(t){return t.trim().split(`
`).map(n=>{var c=/Sensor at x=(.+), y=(.+): closest beacon is at x=(.+), y=(.+)/.exec(n.trim());if(!c)throw"?";var[,o,r,m,a]=c.map(s=>parseInt(s)),e=Math.abs(m-o)+Math.abs(a-r);return{sx:o,sy:r,dist:e}})}const P1=Object.freeze(Object.defineProperty({__proto__:null,part1:F1,part2:G1},Symbol.toStringTag,{value:"Module"}));function J1(t=""){var{rates:n,distances:c}=$n(t),o=Object.keys(n).filter(Y=>n[Y]>0),r=[],m=(Y,d,v,p)=>{r.push({t:Y,tot:d,loc:v,done:p})},a=0;for(m(0,0,"AA","");r.length>0;){var{t:e,tot:s,loc:l,done:f}=r.pop();o.forEach(Y=>{if(!f.includes(Y)){var d=e+c[l][Y]+1;if(!(d>=30)){var v=n[Y]*(30-d),p=s+v;p>a&&(a=p),m(d,p,Y,f+","+Y)}}})}return a}function Q1(t=""){var{rates:n,distances:c}=$n(t),o=Object.keys(n).filter(b=>n[b]>0),r=[],m=(b,$,A,L,q,B)=>{r.push({t1:b,t2:$,tot:A,loc1:L,loc2:q,done:B}),r.length>5e3&&(r.sort((R,T)=>T.tot-R.tot),r.length=4e3)},a=0;m(4,4,0,"AA","AA","");for(var e=0;e<30;e++){var s=r;for(r=[];s.length>0;){var{t1:l,t2:f,tot:Y,loc1:d,loc2:v,done:p}=s.pop(),[g,z]=l<f?[l,f]:[f,l],[V,Z]=l<f?[d,v]:[v,d];o.forEach(b=>{if(!p.includes(b)){var $=g+c[V][b]+1;if(!($>=30)){var A=n[b]*(30-$),L=Y+A,q=p+","+b;L>a&&(a=L),m(z,$,L,Z,b,q)}}})}}return a}function $n(t){var n={},c={},o={};t.trim().split(`
`).forEach(m=>{var a=/Valve (.+) has flow rate=(.+); tunnels? leads? to valves? (.+)/.exec(m.trim());if(!a)throw`?? ${m}`;var[,e,s,l]=a;n[e]=parseInt(s),c[e]=l.split(",").map(f=>f.trim()),o[e]={}});var r=(m,a,e)=>{var s=o[m][a]||999;s<=e||(o[m][a]=e,c[a].forEach(l=>r(m,l,e+1)))};return Object.keys(n).forEach(m=>r(m,m,0)),{rates:n,distances:o}}const H1=Object.freeze(Object.defineProperty({__proto__:null,part1:J1,part2:Q1},Symbol.toStringTag,{value:"Module"}));var vn=[["1111"],["010","111","010"],["111","100","100"],["1","1","1","1"],["11","11"]].map(t=>t.map(n=>parseInt(n,2)<<2));function N1(t){for(var n=0;n<t.length;n++){var c=t.length-1-n,o=t[c].toString(2).padStart(7,"#");o=o.split("").map(r=>r==="1"?"#":".").reverse().join(""),console.log("|"+o+"|     "+c)}console.log("                     ")}function Un(t){var n=t.trim().split("").map(l=>l==="<"?-1:1),c=[],o=0,r=0,m=l=>l>>1,a=l=>l<<1,e=(l,f,Y)=>f.every((d,v)=>(d&l[Y+v])===0),s=2**6;this.rows=c,this.debug=()=>N1(c),this.dropRock=()=>{for(var l=vn[r++%vn.length].slice();c[c.length-1]===0;)c.pop();for(var f=c.length+3;c.length<f+l.length;)c.push(0);for(var Y=!0;Y;){var d=n[o++%n.length],v=l.every(g=>d<1?(g&1)===0:(g&s)===0);if(v){var p=l.map(d<0?m:a);e(c,p,f)&&(l=p)}Y=f>0&&e(c,l,f-1),Y&&f--}for(l.forEach((g,z)=>{c[f+z]|=g});c[c.length-1]===0;)c.pop()}}function W1(t=""){for(var n=new Un(t),c=0;c<2022;c++)n.dropRock();return n.rows.length}function y1(t=""){var n=new Un(t),c=[0],o=[""],r=0,m=0;n:for(var a=1;a<3e3;a++){n.dropRock();var f=n.rows.length,e=n.rows.slice(-30).join(",");c[a]=f,o[a]=e;for(var s=50;s<a/2;s++)if(o[s]===e){r=s,m=a-s;break n}}if(r===0)throw"?";var l=1e12;l-=r;var f=c[r],Y=Math.floor(l/m),d=c[r+m]-c[r];return f+=d*Y,l%=m,f+=c[r+l]-c[r],f}const x1=Object.freeze(Object.defineProperty({__proto__:null,part1:W1,part2:y1},Symbol.toStringTag,{value:"Module"}));function _n(t){var n={},c=(e,s,l)=>e|s<<8|l<<16,o=(e,s,l)=>n[c(e,s,l)]||0,r=(e,s,l,f)=>n[c(e,s,l)]=f,m=t.trim().split(`
`).map(e=>{var[s,l,f]=e.trim().split(",").map(Y=>parseInt(Y));return[s,l,f]}),a=e=>m.forEach(s=>e(...s));return{get:o,set:r,iter:a}}function k1(t=""){var{get:n,set:c,iter:o}=_n(t);o((m,a,e)=>c(m,a,e,1));var r=0;return o((m,a,e)=>{n(m-1,a,e)===0&&r++,n(m+1,a,e)===0&&r++,n(m,a-1,e)===0&&r++,n(m,a+1,e)===0&&r++,n(m,a,e-1)===0&&r++,n(m,a,e+1)===0&&r++}),r}function O1(t=""){var{get:n,set:c,iter:o}=_n(t);o((d,v,p)=>c(d,v,p,1));var r=[1/0,1/0,1/0],m=[-1/0,-1/0,-1/0];o((...d)=>{for(var v=0;v<3;v++)d[v]<r[v]&&(r[v]=d[v]),d[v]>m[v]&&(m[v]=d[v])});var a=[],e=(...d)=>{for(var v=0;v<3;v++)if(d[v]<r[v]-1||d[v]>m[v]+1)return;n(...d)===0&&a.push(d)};for(a.push([r[0]-1,r[1],r[2]]);a.length>0;){var[s,l,f]=a.pop();c(s,l,f,2),e(s+1,l,f),e(s-1,l,f),e(s,l+1,f),e(s,l-1,f),e(s,l,f+1),e(s,l,f-1)}var Y=0;return o((d,v,p)=>{n(d-1,v,p)===2&&Y++,n(d+1,v,p)===2&&Y++,n(d,v-1,p)===2&&Y++,n(d,v+1,p)===2&&Y++,n(d,v,p-1)===2&&Y++,n(d,v,p+1)===2&&Y++}),Y}const I1=Object.freeze(Object.defineProperty({__proto__:null,part1:k1,part2:O1},Symbol.toStringTag,{value:"Module"})),E1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),K1=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),n5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),c5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),t5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),r5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),o5=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"})),a5=`5557
6663
3952
4750
2271
...
cjlhShjchhjGGmNVjplcQgmTPtHPPJmQgQHgtqgZ`,s5=`8-82,3-96
13-95,99-99
4-92,5-93
16-80,16-80
23-36,6-10
...
$ cd zdqprndl
$ ls
197398 tprth.gjn`,Y5=`200111110420341122211300354132530435302054046335421000636521353401523010501311544011230232023001001
...
202312021141114142554431112520342120400556304244541024562551661211241403030453530144444200321002011`,d5=`U 1
D 2
U 1
L 1
R 1
...
Monkey 7:
  ...
  Test: divisible by 7
    ...
    If false: throw to monkey 0`,C5=`abcccccccccaaaaaaaaaaccccccccccccaaaaaaaaccaaccccccccccccccccccccccccccccccccccccccccccccaaaaaa
...
abccccccccccccccccccccaaaaacccaaaaaaaaaaaacccccccccaacaacccccccccccccccccccccccccccccccccaaaaaa`,h5=`[[[[8,6]],[8,[7],[6,7,6,2,4]],10,[[1,7,9],7,[7,9]]],[[4,[],[10,5],[5,4,7],5],8,9,[[5,3,3,6,9],[9,5,10],8],[[0,6,9],[8],4,6,8]]]
...
[[7,[]]]
[[[],9,[[0,9,1],[6],9,[8,4,10,4,7],[6]]],[3,[2,[0,5],7,9],2],[[[9],7,[1,7],9]]]`,i5=`495,144 -> 499,144
...
507,181 -> 507,171 -> 507,181 -> 509,181 -> 509,173 -> 509,181 -> 511,181 -> 511,176 -> 511,181 -> 513,181 -> 513,176 -> 513,181
499,13 -> 499,17 -> 497,17 -> 497,25 -> 505,25 -> 505,17 -> 502,17 -> 502,13
500,158 -> 500,159 -> 513,159`,g5=`Sensor at x=3907621, y=2895218: closest beacon is at x=3790542, y=2949630
...
Sensor at x=2194423, y=3990859: closest beacon is at x=2275951, y=3717327`,B5=`Valve EJ has flow rate=25; tunnel leads to valve MC
...
Valve UI has flow rate=0; tunnels lead to valves AR, CB`,b5=">>>><<<><<<>><<>>>><>>><<<>><<<>><<<<>>>><>>><<>><<<>>>><<<<>>><<><>>><<<<>>>><>><<><<<><<<><<>><><><<<<>>><<<<><<>>>><<>>>><>><<<<>><<<>><<<<>>><<<>>>><<>>><>><>>><>><<>>>><<><><<<>>><<><><<<<>><<<>>><<<<>>>><<><<>>><<<>>><<<><<<<>>>><<<>><><<<>>><<<>>><<<<><<<>>>><<>>><>>><<<<>>>><>><<<<>><<<>>>><<>><>>>><<<>>><<>><<<>>>><>>>><><<>>>><<<>><<>><<>>>><<<>>><<>>><<<<>>><<<<>>>><<<<>>>><>><<<>>><<>><>>><>>><<>>><>>><<<>>><<<<>><<><<<><>>>><<<><>>>><<<<>>><<<<>><><<<<>>><<><<<<>>><<<<>><>><>>><<<><<<<>>>
<<<><<<<>>><<<><<<<>>>><<><>><<<<><>>><<<<><<><<<<>><>><<><<<>>>><<<<>>>><<<<><<>>>><<<<><<<><<>><>><<<>>>><>><<>>><<<<><<>>><<><<<<>><<><<<>><>><<<>>>><<<<><<<<>><>><<<>><<<>>><<>>><<<<>>><<>>><<<<><<<<>><<<<>>><<<>><><<<><>><<<<><<<<>><<<<><<<>>>><<><<><>>><<<<>><<<<>>>><>>><>><<>><<>><<<<>><>>>><<<<>>>><<<>>>><<>><><<<<>>><<<<>>>><<<>>><<><>>><<<<>>>><<<<>>>><<><>>>><<<<><<<><<<<>>><<<<><<<>>>><<<<>><<<>>><<<>>>><<><<><>>>><>>>><<<<>><>><<>>><<<><><<>>><<<>><<>>><<<><<<>>><<>>><<>>>><<<><>>>><><<<>>><>><<<>><<><<<>>><>>><<<<>>>><<<>>><>>><<>><<<>>><>><<>><>>>><<<<><<<>>>><><<<<><<<<><<<<><<>>>><<>>>><<>><<<<>><<<>>><<><<<>>>><<<<>>>><<<>>>><<<><<<>>>><<>>>><<<<>><>><<>>>><>>>><<<>><<<>><>>>><<<>>><>><>>>><>><<<<>><<>>><>><<>>><<<<>><><<<>><<<<>>><>>>><<<<>>><<<><<<>><<><<>>>><>>><<<><<>><<<><<>>>><><<<<>><<<>>><<>>><>>>><>>><>>>><<<><>><<<>>>><>>><<<>>><<><<>><<<<><<><>><<<>>><<<>>><<<>>>><<<><<<<>>><<<<><<<><<<>>>><<>>><>>>><<<>><<>>>><<><<<<><<<<>><<>>><<><<>><<><>>>><>><<<<>>><<<<>>>><<<><<<<>>>><>>>><<<><<>><<>>><<<<>><<>><<>>>><>>><>>><<>><>>><<>><<<<>>><><<>>><<<<>><<<>>><<<>><><<<<>><<<<>>><<<>><<<>>><>>>><<<>>>><<>>><>><>><<<<>>>><<<>>>><<>><<<<>>><<<<>>><><>><<><>>>><<<<>><<>>><>>>><<<><<<<>>>><>>><<<<>>>><<><<<<>>><<<<>>><<<<>>>><><<>><<>><<<>><<><<<>>>><<<>>>><<>><<<<>><>><<<>>>><<<<><<<>>>><<<>>><<<<>>>><<>>>><<<><<<<>>>><><>><<>>><<<<><><<>>>><<<>>>><<<><<<<>><<<<>>><<<><<<>><<><<<>>>><<>>><>><>><<>>>><><<><<<<>>><<>>>><<<<>>><<<<><><<<><<<>>><<><<>>>><<<>>><<<>><<>>>><<<<>>>><>><<>>><<>>>><<<><<>>>><<<>>>><<<<>>>><<<<><<<<><<<><<<<>>>><<>>><<>>><<>><<><<>>><<<>>>><>><<<><<>>>><<>><<><<<>>>><>><>>>><<>>>><><>><<<<><<<<>>><<<><<>><<>>><<<<>>>><>>>><<><<<>>><<<>>>><<>>><<>><<>",j5=`19,8,6
5,10,4
4,11,15
1,13,11
3,15,10
...
5,16,5
12,1,9
12,15,2`,w5="",L5="",D5="",R5="",q5="",u5="",z5="";var Yn=Object.assign({"./solutions/solution-01.js":In,"./solutions/solution-02.js":n1,"./solutions/solution-03.js":r1,"./solutions/solution-04.js":e1,"./solutions/solution-05.js":l1,"./solutions/solution-06.js":Y1,"./solutions/solution-07.js":C1,"./solutions/solution-08.js":g1,"./solutions/solution-09.js":j1,"./solutions/solution-10.js":D1,"./solutions/solution-11.js":z1,"./solutions/solution-12.js":U1,"./solutions/solution-13.js":T1,"./solutions/solution-14.js":X1,"./solutions/solution-15.js":P1,"./solutions/solution-16.js":H1,"./solutions/solution-17.js":x1,"./solutions/solution-18.js":I1,"./solutions/solution-19.js":E1,"./solutions/solution-20.js":K1,"./solutions/solution-21.js":n5,"./solutions/solution-22.js":c5,"./solutions/solution-23.js":t5,"./solutions/solution-24.js":r5,"./solutions/solution-25.js":o5}),dn=Object.assign({"./inputs/input-01.txt":a5,"./inputs/input-02.txt":e5,"./inputs/input-03.txt":m5,"./inputs/input-04.txt":s5,"./inputs/input-05.txt":l5,"./inputs/input-06.txt":f5,"./inputs/input-07.txt":v5,"./inputs/input-08.txt":Y5,"./inputs/input-09.txt":d5,"./inputs/input-10.txt":p5,"./inputs/input-11.txt":A5,"./inputs/input-12.txt":C5,"./inputs/input-13.txt":h5,"./inputs/input-14.txt":i5,"./inputs/input-15.txt":g5,"./inputs/input-16.txt":B5,"./inputs/input-17.txt":b5,"./inputs/input-18.txt":j5,"./inputs/input-19.txt":w5,"./inputs/input-20.txt":L5,"./inputs/input-21.txt":D5,"./inputs/input-22.txt":R5,"./inputs/input-23.txt":q5,"./inputs/input-24.txt":u5,"./inputs/input-25.txt":z5});function Z5(t,n,c){this.day=t||"0",this.input=n||"",this.part1=c.part1||null,this.part2=c.part2||null}function $5(){var t={},n={};Object.keys(dn).forEach(r=>{var m=/input-(..)/.exec(r)[1];t[m]=dn[r]||""}),Object.keys(Yn).forEach(r=>{var m=/solution-(..)/.exec(r)[1];n[m]=Yn[r]||null});var c={},o=Object.keys(t).sort();return o.forEach(r=>{c[r]=new Z5(r,t[r],n[r])}),c}function pn(t,n,c){const o=t.slice();return o[18]=n[c],o}function An(t){let n,c=t[18]+"",o,r,m;function a(){return t[8](t[18])}return{c(){n=w("span"),o=x(c),h(n,"class","button svelte-1cclp05"),sn(n,"current",t[18]===t[2])},m(e,s){gn(e,n,s),C(n,o),r||(m=[P(n,"keydown",_5),P(n,"click",a)],r=!0)},p(e,s){t=e,s&2&&c!==(c=t[18]+"")&&I(o,c),s&6&&sn(n,"current",t[18]===t[2])},d(e){e&&cn(n),r=!1,F(m)}}}function U5(t){let n,c,o,r,m,a,e,s,l,f,Y,d,v,p,g,z,V,Z,b,$,A,L,q,B,R,T,S,on,_,k,an,M=t[1],D=[];for(let i=0;i<M.length;i+=1)D[i]=An(pn(t,M,i));return{c(){n=w("div"),c=w("h2"),c.textContent="Advent 2022",o=U(),r=w("div"),m=w("div"),m.innerHTML='<h4 class="svelte-1cclp05">Days:</h4>',a=U(),e=w("div");for(let i=0;i<D.length;i+=1)D[i].c();s=U(),l=w("div"),f=w("h4"),f.textContent="Output 1:",Y=U(),d=w("div"),v=x(t[5]),p=U(),g=w("textarea"),V=U(),Z=w("div"),b=w("h4"),b.textContent="Output 2:",$=U(),A=w("div"),L=x(t[6]),q=U(),B=w("textarea"),T=U(),S=w("div"),S.innerHTML='<h4 class="svelte-1cclp05">Input:</h4>',on=U(),_=w("textarea"),h(m,"class","label svelte-1cclp05"),h(e,"class","day-list"),h(f,"class","svelte-1cclp05"),h(d,"class","time svelte-1cclp05"),h(l,"class","label svelte-1cclp05"),h(g,"name","output1"),h(g,"id","output1"),h(g,"rows",z=W(t[3])),h(g,"class","svelte-1cclp05"),h(b,"class","svelte-1cclp05"),h(A,"class","time svelte-1cclp05"),h(Z,"class","label svelte-1cclp05"),h(B,"name","output2"),h(B,"id","output2"),h(B,"rows",R=W(t[4])),h(B,"class","svelte-1cclp05"),h(S,"class","label svelte-1cclp05"),Xn(S,"align-self","flex-start"),h(_,"name","input"),h(_,"id","input"),h(_,"rows","14"),h(_,"class","svelte-1cclp05"),h(r,"class","layout svelte-1cclp05"),h(n,"class","outer svelte-1cclp05")},m(i,u){gn(i,n,u),C(n,c),C(n,o),C(n,r),C(r,m),C(r,a),C(r,e);for(let j=0;j<D.length;j+=1)D[j].m(e,null);C(r,s),C(r,l),C(l,f),C(l,Y),C(l,d),C(d,v),C(r,p),C(r,g),X(g,t[3]),C(r,V),C(r,Z),C(Z,b),C(Z,$),C(Z,A),C(A,L),C(r,q),C(r,B),X(B,t[4]),C(r,T),C(r,S),C(r,on),C(r,_),X(_,t[0]),k||(an=[P(g,"input",t[9]),P(B,"input",t[10]),P(_,"input",t[11])],k=!0)},p(i,[u]){if(u&134){M=i[1];let j;for(j=0;j<M.length;j+=1){const en=pn(i,M,j);D[j]?D[j].p(en,u):(D[j]=An(en),D[j].c(),D[j].m(e,null))}for(;j<D.length;j+=1)D[j].d(1);D.length=M.length}u&32&&I(v,i[5]),u&8&&z!==(z=W(i[3]))&&h(g,"rows",z),u&8&&X(g,i[3]),u&64&&I(L,i[6]),u&16&&R!==(R=W(i[4]))&&h(B,"rows",R),u&16&&X(B,i[4]),u&1&&X(_,i[0])},i:H,o:H,d(i){i&&cn(n),Vn(D,i),k=!1,F(an)}}}function W(t){var n=String(t||"").split(`
`).length;return Math.min(n,Math.max(n,1,10))}const _5=()=>{};function S5(t,n,c){var o=[],r="xx",m="",a="",e="",s="1ms",l="1ms",f=$5(),Y=()=>Object.keys(f).filter(A=>!!f[A].part1).sort();o=Y();function d(A=1){if(!v[A]){var L=f[r]||{},q=A===1?L.part1:L.part2;!q||(v[A]=!0,setTimeout(()=>{var B=performance.now(),R="(error)";try{R=q(e)}catch(S){R=String(S);var T=/:(\d+:\d+)\)/.exec(S.stack||"");T&&(R=`(${T[1]}) ${R}`)}z(A,R,performance.now()-B),v[A]=!1}))}}var v=[!1,!1,!1];function p(A=""){A&&c(2,r=A),c(0,e=f[A].input)}function g(A){d(1),d(2)}function z(A,L,q){var B=`(${Math.round(q)}ms)`;A===1&&c(3,m=L),A===1&&c(5,s=B),A===2&&c(4,a=L),A===2&&c(6,l=B)}setTimeout(()=>{p(o[o.length-1]),g()},100);const V=A=>p(A);function Z(){m=this.value,c(3,m)}function b(){a=this.value,c(4,a)}function $(){e=this.value,c(0,e)}return t.$$.update=()=>{t.$$.dirty&1&&g()},[e,o,r,m,a,s,l,p,V,Z,b,$]}class T5 extends xn{constructor(n){super(),yn(this,n,S5,U5,Sn,{})}}new T5({target:document.querySelector(".app")});
